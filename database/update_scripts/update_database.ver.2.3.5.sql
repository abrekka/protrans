...
intelle_Ordre.dbo.IPK_ord.maks_hoyde
...
SELECT     superoffice.crm5.sale.sale_id, superoffice.crm5.sale.number1, superoffice.crm5.sale.amount, superoffice.crm5.sale.saledate, 
                      ...
                      F0100.dbo.Ord.Inf3 AS telephonenr_site,intelle_Ordre.dbo.IPK_ord.maks_hoyde
FROM         superoffice.crm5.sale INNER JOIN
...
/**********************************************************************************************************************************************************
alter table customer_order add max_tross_height int;
/**********************************************************************************************************************************************************
update customer_order set max_tross_height=(select max(cast(order_line_attribute_value as int)) 
											from order_line_attribute,order_line 
											where order_line_attribute.order_line_id=order_line.order_line_id and order_line.order_id=customer_order.order_id and
												  order_line_attribute_name='Makshøyde' and order_line_attribute_value is not null and len(order_line_attribute_value)<>0 and order_line_attribute_value<>'nei')
/**********************************************************************************************************************************************************
