CREATE VIEW [dbo].[productionoverview_v]
AS
...
dbo.Customer_order.cached_comment as comment,
-1 as post_shipment_id,
...
dbo.order_line.action_started as wall_action_started,
dbo.order_line.produced as wall_produced,
dbo.order_line.real_production_hours as wall_real_production_hours,
dbo.Customer_order.estimated_time_gavl,
order_line_gavl.action_started as gavl_action_started,
order_line_gavl.produced as gavl_produced,
order_line_gavl.real_production_hours as gavl_real_production_hours,
...
dbo.order_line on dbo.Customer_order.Order_id=dbo.order_line.Order_id and dbo.order_line.article_path='Vegg' left outer join
dbo.order_line order_line_gavl on dbo.Customer_order.Order_id=order_line_gavl.Order_id and order_line_gavl.article_path='Gavl' left outer join
...
dbo.own_delivery_cost_v on dbo.Customer_order.Order_id=dbo.own_delivery_cost_v.order_id
