alter table customer_order add tross_drawer nvarchar(50);
alter table customer_order add tross_ready datetime;
/********************************************************************************************************************************************************
...
CAST(dbo.Transport.Transport_Week AS nvarchar(2)) + '- ' + dbo.Transport.Transport_name AS transport_details,dbo.customer_order.tross_ready
