...
public class MainPackageViewTest {
	...
	public void setUp() throws Exception {
		...
		when(managerRepository.getMainPackageVManager()).thenReturn(
				mainPackageVManager);
	...
	public void testSetColliHeight() {
		...
		DialogFixture editPackInitials = WindowFinder.findDialog(
				"EditPackInitials").using(dialogFixture.robot);
		...
		editPackInitials = WindowFinder.findDialog("EditPackInitials").using(
				dialogFixture.robot);
	...
	public void testPackOrderLine() {
		...
		DialogFixture optionDialog = WindowFinder.findDialog("Velg kolli")
				.using(dialogFixture.robot);
