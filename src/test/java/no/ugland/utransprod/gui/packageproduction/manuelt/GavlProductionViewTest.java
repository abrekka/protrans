...
public class GavlProductionViewTest extends PackageProductionTest {
	...
	public void setUp() throws Exception {
		...
		GavlProductionWindow gavlProductionWindow = new GavlProductionWindow(login, managerRepository,
				deviationViewHandlerFactory, setProductionUnitActionFactory, null);
	...
	public void testShowReady() {
		...
		JTableFixture tableFixture = dialogFixture.table(TableEnum.TABLEPRODUCTIONGAVL.getTableName());
	...
	public void testSearchSetProduced() {
		...
		dialogFixture.table(TableEnum.TABLEPRODUCTIONGAVL.getTableName()).cell(row(0).column(1)).select();
