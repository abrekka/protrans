...
public class EditDeviationViewTest {
	...
	public void setUp() throws Exception {
		...
		if (user == null) {
			...
			user = new ApplicationUser(null, "avviktransport", "avviktransport", "avviktransport", "avviktransport",
					null, "Nei", jobFunction, productArea, null);
		...
		final EditDeviationView editDeviationView = new EditDeviationView(false, deviationModel, deviationViewHandler,
				false, true, true);
	...
	public void testAddArticle() {
		...
		DialogFixture editArticleType = new DialogFixture(dialogFixture.robot,
				(JDialog) dialogFixture.robot.finder().findByName("ArticleTypeView"));
		editArticleType.list("ListArticles").selectItem(0);
		editArticleType.button("ButtonOkArticle").click();

		JOptionPaneFixture optionPaneFixture = new JOptionPaneFixture(dialogFixture.robot,
	...
	public void testAddCost() {
		...
		DialogFixture costDialog = new DialogFixture(dialogFixture.robot,
				(JDialog) dialogFixture.robot.finder().findByName("OrderCostView"));
	...
	public void testSetPreventiveAction() {
		...
		DialogFixture addPreventiveAction = WindowFinder.findDialog("EditPreventiveActionView")
	...
	public void testNoOtherDeviation() {
		...
		JTabbedPaneFixture tabbedPane = new JTabbedPaneFixture(dialogFixture.robot,
				dialogFixture.robot.finder().findByType(JTabbedPane.class));
