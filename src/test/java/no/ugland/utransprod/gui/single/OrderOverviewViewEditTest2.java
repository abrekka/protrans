...
final ApplicationUser applicationUser = new ApplicationUser();
	...
	public void showOwnDeviation() throws Exception {
		...
		if (tableDevition.target.getRowCount() != 0) {
			...
			DialogFixture deviationDialog = WindowFinder.findDialog(
					...
					dialogFixture.robot);
			assertEquals(orderNr,
					deviationDialog.textBox("TextFieldOrderNr").target
							.getText());
		}
	}
	...
	public void showPaidDate() {
		...
		new DialogFixture(dialogFixture.robot, (JDialog) dialogFixture.robot
				.finder().findByName("EditOrderView"));
