...
public class OrderOverviewViewTest {
	...
	public void articleStatistics() {
		...
		Component comp = dialogFixture.robot.finder().findByName(
				"SearchAttributeView");
		assertNotNull(comp);
	}
	...
	public void importCutting() {
		...
		String cuttingFileName = editDialog.textBox("TextFieldCuttingFile").target
				.getText();
	...
	public void showCuttingFile() {
		...
		DialogFixture showFileDialog = WindowFinder.findDialog("FileView")
				.withTimeout(20000).using(dialogFixture.robot);
