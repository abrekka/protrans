...
public class ArticlePackageViewTest {
	...
	when(colliManager.findByNameAndOrder(anyString(), (Order) anyObject())).thenReturn(colli);
	...
	ArticlePackageViewHandlerFactory articlePackageViewHandlerFactory = new ArticlePackageViewHandlerFactory() {
		...
		return new ArticlePackageViewHandler(setProductionUnitActionFactory, login, managerRepository, null, null, null, null);
	    }
	};
	final ArticleProductionPackageView articlePackageView = new ArticleProductionPackageView(articlePackageViewHandlerFactory, null, null);
