...
public class InvoiceViewTest {
	...
	when(productAreaGroupManager.findAll()).thenReturn(productAreaGroupList);
	...
	AbstractProductionPackageViewHandler<FaktureringV> productionViewHandler = new InvoiceViewHandler(login, new InvoiceApplyList(login,
		faktureringVManager), managerRepository, deviationViewHandlerFactory);

	final ApplyListView<FaktureringV> viewer = new ApplyListView<FaktureringV>(productionViewHandler, false);
