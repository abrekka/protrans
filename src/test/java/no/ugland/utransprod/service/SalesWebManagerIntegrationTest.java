...
public class SalesWebManagerIntegrationTest {
	...
	// assertEquals(BigDecimal.valueOf(12465248),
	// statistic.getOrderReserve());
	...
	assertEquals(BigDecimal.valueOf(19500000), statistic.getAccumulatedSaleBudget());
	...
	assertEquals(BigDecimal.valueOf(6700000), statistic.getAccumulatedSaleBudget());
	assertEquals(SalesGoal.GOAL_100, statistic.getSalesGoalYear());
    }
}
