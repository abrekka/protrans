...
public class SaleStatusOrderReserveVManagerTest {
	...
	public void getReserveForGarasje(){
		SaleStatusOrderReserveVManager salesStatusOrderReserveVManager=(SaleStatusOrderReserveVManager)ModelUtil.getBean(SaleStatusOrderReserveVManager.MANAGER_NAME);
