...
public class SalesVManagerTest {
	...
	for (SaleReportSum sum : salesReportOffer) {
		...
		assertEquals(BigDecimal.valueOf(323312), sum.getSumOwnProduction());
	...
	List<SaleReportSum> salesReportConfirm = orderManager.groupSumCountyByProductAreaConfirmPeriode(
		productAreaManager.findByName("Garasje villa"),
