 ...
 * 
 */
public class FaktureringV extends BaseObject implements TextRenderable,
		Applyable {
	/**
	 * 
	 */
	 ...
	 */
	public FaktureringV(Integer orderId, Integer customerNr, String firstName,
			String lastName, String postalCode, String postOffice,
			String constructionName, Date sent, BigDecimal customerCost,
			String orderNr, Date invoiceDate, String comment,
			Date assembliedDate, String productAreaGroupName) {
		super();
	...
	public String toString() {
		return customerNr + " " + firstName + " " + lastName + " " + postalCode
