...
public class SutakPackageV extends BaseObject implements TextRenderable, PackableListItem {
	...
	public SutakPackageV() {
		super();

	}

	public SutakPackageV(final Integer aOrderLineId, final String someCustomerDetails, final String aOrderNr,
	...
	public boolean equals(final Object other) {
		if (!(other instanceof SutakPackageV))
			return false;
		SutakPackageV castOther = (SutakPackageV) other;
