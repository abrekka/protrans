...
public class Production extends PackageProduction{
    ...
    public Production(Integer orderLineId, Integer customerNr,
            ...
            String productAreaGroupName, Date dateActionStarted,final Date aProducedDate,final Date aProductionDate,final String aProductionUnitName,Colli aColli) {
