...
public class Supplier extends BaseObject {
    ...
    public Supplier(Integer supplierId, String supplierName,
            String supplierDescription, String phone,
            SupplierType supplierType, String address, String postalCode,
            String postOffice, String fax, Set<Employee> employees,
            final Set<Assembly> someAssemblies,final Integer isInactive) {
        super();
    ...
    public boolean equals(final Object other) {
        ...
        return new EqualsBuilder().append(supplierName, castOther.supplierName)
                .isEquals();
    }
