...
public class MainPackageV extends BaseObject implements TextRenderable {
	 ...
	 */
	public MainPackageV(Integer orderId, String customerDetails,
			String transportDetails, Integer packageReady, Date donePackage,
			String comment, Integer transportYear, Integer transportWeek,
			String orderNr, String address, String constructionTypeName,
			String info, Integer customerNr, Date loadingDate,
