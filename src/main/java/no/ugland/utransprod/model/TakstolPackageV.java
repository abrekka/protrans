 ...
 * @author atle.brekka
 */
public class TakstolPackageV extends PackageProduction implements TextRenderable,
        PackableListItem,TakstolV {
    ...
    public TakstolPackageV(final Integer aOrderLineId, final Integer aCustomerNr,
            ...
            final Colli aColli, final String someTransportDetails, final String aComment,
            final Integer aTransportYear, final Integer aTransportWeek, final String aLoadTime,
            final Integer aPostShipmentId, final String aProductAreaGroupName,final Date actionStartedDate) {
        super(aOrderLineId,aCustomerNr,someCustomerDetails,aOrderNr,aAddress,someInfo,aConstructionTypeName,aArticleName,someAttributeInfo,aNumberOfItems,aLoadingDate,someTransportDetails,aComment,aTransportYear,aTransportWeek,aLoadTime,aPostShipmentId,aProductAreaGroupName,actionStartedDate,aColli);
    }
