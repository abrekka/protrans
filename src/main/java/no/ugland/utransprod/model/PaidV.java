...
public class PaidV extends BaseObject implements TextRenderable, Applyable {
     ...
     */
    public PaidV(Integer orderId, Integer customerNr, String firstName, String lastName, String postalCode, String postOffice,
	    String constructionName, Date sent, BigDecimal customerCost, String orderNr, Date paidDate, String comment, Integer doAssembly,
	...
	for (CustTr custTr : invoices) {
	    invoiceAmount = invoiceAmount.add(custTr.getInvoiceAmount() != null ? custTr.getInvoiceAmount() : BigDecimal.ZERO);
	}
	...
	List<CustTr> invoices = custTrs != null ? custTrs : new ArrayList<CustTr>();
	for (CustTr custTr : invoices) {
	    dueDate = dueDate == null ? custTr.getDueDate() : dueDate.before(custTr.getDueDate() != null ? custTr.getDueDate() : dueDate) ? custTr
		    .getDueDate() : dueDate;
	}
