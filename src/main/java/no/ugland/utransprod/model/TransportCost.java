...
public class TransportCost extends BaseObject {
    ...
    private Integer zoneAdditionAssembly;

    public TransportCost() {
	super();
    }

    public TransportCost(final Integer aTransportCostId, final String aPostalCode, final String aPlace, final Area aArea, final BigDecimal aCost,
	    final BigDecimal aAddition, final Integer aValid, final Integer aMaxAddition) {
	super();
	...
	return new EqualsBuilder().append(postalCode, castOther.postalCode).isEquals();
    }
	...
	return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("transportCostId", transportCostId).append("postalCode", postalCode)
		.append("place", place).append("area", area).append("cost", cost).append("addition", addition).append("valid", valid)
		.append("maxAddition", maxAddition).toString();
    }
    ...
    public void setZoneAdditionAssembly(Integer zoneAddition) {
	this.zoneAdditionAssembly = zoneAddition;
    }

    public Integer getZoneAdditionAssembly() {
	return zoneAdditionAssembly;
    }
