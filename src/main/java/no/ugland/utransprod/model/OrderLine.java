...
public class OrderLine extends BaseObject
		implements Comparable<OrderLine>, IArticle, TransportLetterObject, PackableListItem {
	...
	public OrderLine(final Integer aOrderLineId, final Order aOrder,
			final ConstructionTypeArticle aConstructionTypeArticle, final ArticleType aArticleType,
			final Set<OrderLineAttribute> aOrderLineAttributes, final OrderLine aOrderLineRef,
			final Set<OrderLine> someOrderLines, final Integer aNumberOfItems, final Integer aDialogOrder,
			final Date producedDate, final String aArticlePath, final Colli aColli, final Integer doHasArticle,
			final String aAttributeInfo, final Integer thisIsDefault, final PostShipment aPostShipment,
			final ExternalOrderLine aExternalOrderLine, final Deviation aDeviation, final Date actionStartedDate,
	...
	private String getOrderLineAttributesAsString(OrderLine orderLine) {
		...
		if (attributes != null) {
			for (OrderLineAttribute attribute : attributes) {
				tmpBuffer.append(attribute.getAttributeName()).append(":").append(attribute.getAttributeValue())
						.append(";");
			}
		}
	...
	public String getSpecialConcerns() {
		...
		if (orderLineAttributes != null) {
			for (OrderLineAttribute attribute : orderLineAttributes) {
				if (attribute.getAttributeValue() != null && attribute.getAttributeValue().equalsIgnoreCase("Ja")
	 ...
	 * @return ny instans
	 */
	public static OrderLine getInstance(final Order aOrder, final ArticleType aArticleType, final Deviation deviation,
			final PostShipment postShipment) {
		return new OrderLine(null, aOrder, null, aArticleType, null, null, null, null, null, null, null, null, null,
				null, null, postShipment, null, deviation, null, null, null, null);
	}
	 ...
	 * @return ny instans
	 */
	public static OrderLine getInstance(final Order aOrder, final ArticleType aArticleType,
			final OrderLine aOrderLineRef, final Deviation deviation) {
		return new OrderLine(null, aOrder, null, aArticleType, null, aOrderLineRef, null, null, null, null, null, null,
	...
	public static OrderLine getInstance(final Order aOrder, final Integer aDialogOrder, final Deviation deviation) {
		return new OrderLine(null, aOrder, null, null, null, null, null, null, aDialogOrder, null, null, null, null,
	 ...
	 * @return ny instans
	 */
	public static OrderLine getInstance(final Order aOrder, final ConstructionTypeArticle aConstructionTypeArticle,
			final Integer aNumberOfItems, final Integer aDialogOrder, final Deviation deviation, final Integer prodNo,
			final Integer lnNo) {
		return new OrderLine(null, aOrder, aConstructionTypeArticle, null, null, null, null, aNumberOfItems,
				aDialogOrder, null, null, null, null, null, null, null, null, deviation, null, null, prodNo, lnNo);
	}
	 ...
	 */
	public static OrderLine getInstance(final Order aOrder, final ConstructionTypeArticle aConstructionTypeArticle,
			final OrderLine aOrderLineRef, final Integer aNumberOfItems, final Integer aDialogOrder,
			final Deviation deviation) {
		return new OrderLine(null, aOrder, aConstructionTypeArticle, null, null, aOrderLineRef, null, aNumberOfItems,
				aDialogOrder, null, null, null, null, null, null, null, null, deviation, null, null, null, null);
	}
	 ...
	 * @return ny instans
	 */
	public static OrderLine getInstance(final Order aOrder, final ArticleType aArticleType, final String aArticlePath,
			final Integer hasArticle) {
		return new OrderLine(null, aOrder, null, aArticleType, null, null, null, null, null, null, aArticlePath, null,
				hasArticle, null, null, null, null, null, null, null, null, null);
	}
	...
	public boolean equals(final Object other) {
		...
		boolean test = new EqualsBuilder().append(orderLineId, castOther.orderLineId).append(order, castOther.order)
				.append(constructionTypeArticle, castOther.constructionTypeArticle)
				.append(articleType, castOther.articleType).append(orderLineRef, castOther.orderLineRef)
				.append(numberOfItems, castOther.numberOfItems).append(produced, castOther.produced)
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(orderLineId).append(order).append(constructionTypeArticle)
				.append(articleType).append(orderLineRef).append(numberOfItems).append(produced).append(colli)
				.append(lnNo).toHashCode();
	}
	...
	private String generateTakstolDetails() {
		...
		if (orderLineAttributes != null) {
			...
			for (OrderLineAttribute attribute : orderLineAttributes) {
				if ("Stående tak".equalsIgnoreCase(attribute.getAttributeName())
			...
			for (int i = 0; i < conditions.length; i++) {
				...
				for (OrderLineAttribute attribute : attributes) {
					if (attribute.getAttributeName().equalsIgnoreCase(attributeName)
							&& attribute.getArticleName().equalsIgnoreCase(articleName)) {
						if (attribute.getAttributeValue() == null
								|| !attribute.getAttributeValue().equalsIgnoreCase(attributeValue)) {
							return false;
						}
					}
	...
	public final void setAttributeValue(final OrderLineAttribute orderLineAttribute) {
		if (orderLineAttributes != null) {
			...
			found = !found && orderLineAttribute.getAttributeValue().length() != 0
					? orderLineAttributes.add(createNewAttribute(orderLineAttribute)) : false;
	...
	public static class OrderLineNumberComparator implements Comparator<OrderLine> {
		...
		public int compare(OrderLine orderLine1, OrderLine orderLine2) {
			return new CompareToBuilder().append(orderLine2.getNumberOfItems(), orderLine1.getNumberOfItems())
					.toComparison();
		}
	...
	public BigDecimal getSpentTime() {
		return realProductionHours == null ? Tidsforbruk.beregnTidsforbruk(actionStarted, produced)
				: realProductionHours;
	}
