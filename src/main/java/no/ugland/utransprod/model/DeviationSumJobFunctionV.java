...
public class DeviationSumJobFunctionV extends BaseObject{
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(deviationSumJobFunctionVPK)
				.toHashCode();
	}
	...
	public void setDeviationSumJobFunctionVPK(
			DeviationSumJobFunctionVPK deviationSumJobFunctionVPK) {
