 ...
 * @author atle.brekka
 */
public class TaksteinSkarpnesV extends BaseObject implements TextRenderable,
        Produceable {
    ...
    public TaksteinSkarpnesV(final Integer aOrderLineId,
            final Integer aCustomerNr, final String someCustomerDetails,
            final String aOrderNr, final String aAddress,
            final String aArticleName, final String aAttributeInfo,
            final Integer aNumberOfItems, final Date aLoadingDate,
            final Date producedDate, final String someTransportDetails,
            final Integer aTransportYear, final Integer aTransportWeek,
            final String aLoadTime, final String aComment,
            final String aProductAreaGroupName, final Date actionStartedDate) {
        super();
