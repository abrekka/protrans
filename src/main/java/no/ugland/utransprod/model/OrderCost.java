...
public class OrderCost extends BaseObject {
     ...
     */
    public OrderCost(final Integer aOrderCostId, final Order aOrder, final CostType aCostType, final CostUnit aCostUnit,
	    final BigDecimal aCostAmount, final Integer aInclVat, final Supplier aSupplier, final String aInvoiceNr, final Deviation aDeviation,
	...
	return new ToStringBuilder(this).append("orderCostId", orderCostId).append("order", order).append("costType", costType)
		.append("costUnit", costUnit).append("costAmount", costAmount).append("inclVat", inclVat).toString();
    }
	...
	return new EqualsBuilder().append(orderCostId, castOther.orderCostId).append(costType, castOther.costType)
		.append(costUnit, castOther.costUnit).append(costAmount, castOther.costAmount).append(supplier, castOther.supplier)
		.append(invoiceNr, castOther.invoiceNr).append(comment, castOther.comment).isEquals();
    }

    @Override
    public int hashCode() {
	return new HashCodeBuilder().append(orderCostId).append(costType).append(costUnit).append(costAmount).append(supplier).append(invoiceNr)
