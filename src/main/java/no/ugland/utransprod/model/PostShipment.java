...
public class PostShipment extends AbstractTransportable implements TextRenderable, TransportListable, Packable {
     ...
     * @param postShipmentReady
     */
    public PostShipment(Integer postShipmentId, Date postShipmentComplete, Order order, Transport transport, Deviation deviation, Date sent,
     ...
     * @param cachedComment
     */
    public PostShipment(Integer postShipmentId, Order order, Transport transport, Deviation deviation, Date sent, Set<Colli> collies,
	    Date postShipmentComplete, Date postShipmentReady, Set<OrderLine> orderLines, PostShipment postShipmentRef,
	    Set<PostShipment> postShipmentRefs, String status, String packedBy, Integer garageColliHeight, String cachedComment,
	    OrderCost aOrderCost, final Integer aTakstolHeight) {
	this.postShipmentId = postShipmentId;
	this.order = order;
	this.transport = transport;
	this.deviation = deviation;
	...
	stringBuffer.append(" - ").append(order.getOrderNr()).append(",").append(order.getConstructionTypeString()).append(",")
	...
	return new EqualsBuilder().append(order, castOther.order).append(transport, castOther.transport).append(sent, castOther.sent).isEquals();
    }
