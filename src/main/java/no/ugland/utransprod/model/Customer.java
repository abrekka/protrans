...
public class Customer extends BaseObject {
     ...
     * @param orders
     */
    public Customer(Integer customerId, Integer customerNr, String firstName, String lastName, Set<Order> orders) {
	super();
	...
	return new EqualsBuilder().append(customerNr, castOther.customerNr).isEquals();
    }
