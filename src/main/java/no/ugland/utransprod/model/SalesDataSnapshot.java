...
public class SalesDataSnapshot extends BaseObject {
    ...
    public SalesDataSnapshot(final Integer aSnapshotId, final Integer aSaleId,
            ...
            final String aCountyName, final String aSalesman,
    ...
    public final boolean equals(final Object other) {
        ...
        return new EqualsBuilder().append(snapshotId, castOther.snapshotId)
                .isEquals();
    }
    ...
    public final String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append(
                "snapshotId", snapshotId).append("saleId", saleId).append(
                "orderNr", orderNr).append("probability", probability).append(
                "productAreaNr", productAreaNr).append("saledate", saledate).append(
                "registered", registered).append("customerNr", customerNr)
                .append("customerName", customerName).append("deliveryAddress",
                        deliveryAddress).append("postalCode", postalCode)
                .append("postOffice", postOffice).append("ownProductionCost",
