...
public class SalesDataSnapshot extends BaseObject {
    ...
    public SalesDataSnapshot(final Integer aSnapshotId, final Integer aSaleId,
	    final String aOrderNr,
	...
	return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("snapshotId", snapshotId).append("saleId", saleId)
		.append("orderNr", orderNr).append("probability", probability).append("productAreaNr", productAreaNr).append("saledate", saledate)
