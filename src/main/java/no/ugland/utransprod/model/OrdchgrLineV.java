...
public class OrdchgrLineV extends BaseObject {
    ...
    public String getLineLine() {
        ...
        stringBuilder.append(HEAD_START).append(
                StringUtils.leftPad("", NUMBER_OF_SEMICOLONS, ";")).append(HEAD_END);
        String lineString=StringUtils.replaceOnce(stringBuilder.toString(),
                LN_NO_STRING, ordchgrLineVPK.getLnNo() != null ? ordchgrLineVPK.getLnNo().toString() : "");
        return StringUtils.replaceOnce(lineString,
                LINE_STATUS_STRING, lineStatus.toString());
    }
