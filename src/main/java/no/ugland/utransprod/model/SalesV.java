...
public class SalesV extends BaseObject {
    ...
    public SalesV(final Integer aSaleId, final String aOrderNr, final Integer aProbability, final Integer aProductAreaNr, final Date aSaledate,
	...
	return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("saleId", saleId).append("orderNr", orderNr)
		.append("probability", probability).append("productAreaNr", productAreaNr).append("saledate", saledate)
		.append("registered", registered).append("customerNr", customerNr).append("customerName", customerName)
		.append("deliveryAddress", deliveryAddress).append("postalCode", postalCode).append("postOffice", postOffice)
		.append("ownProductionCost", ownProductionCost).append("transportCost", transportCost).append("assemblyCost", assemblyCost)
		.append("yesLines", yesLines).append("contributionMargin", contributionMargin).append("countyName", countyName)
