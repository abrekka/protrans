...
public class Ordln extends BaseObject {
	...
	public Ordln(final OrdlnPK aOrdlnPK, final String aDescription,
			final BigDecimal aDiscount, final BigDecimal aCostPrice,
			final BigDecimal aPrice, final BigDecimal aFree1,
			final BigDecimal aNoOrg, final Prod aProd, final BigDecimal aLgtU,
			final BigDecimal aHgtU, final BigDecimal aFree4) {
		super();
	...
	public final boolean equals(final Object other) {
		...
		return new EqualsBuilder().append(ordlnPK, castOther.ordlnPK)
				.isEquals();
	}
	...
	public final String toString() {
		return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE)
				.append("ordlnPK", ordlnPK)
				// .append("productnr", productnr)
				.append("description", description)
				.append("discount", discount).append("free1", free1).append(
						"costPrice", costPrice).append("price", price)
				.toString();
	}
	...
	public static enum CostLine {
		MONTERING_VILLA("MONTERING VILLA") {
			@Override
			public OrderCost addCost(CostTypeManager costTypeManager,
					CostUnitManager costUnitManager, Order order,
		...
		public abstract OrderCost addCost(CostTypeManager costTypeManager,
				CostUnitManager costUnitManager, Order order,
				BigDecimal costAmount);
	}
