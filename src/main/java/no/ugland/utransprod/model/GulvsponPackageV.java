 ...
 * @author atle.brekka
 */
public class GulvsponPackageV extends BaseObject implements TextRenderable,
        PackableListItem {
    ...
    public GulvsponPackageV(final Integer aOrderLineId,
            final String someCustomerDetails, final String aOrderNr,
            final String aAddress, final String someInfo,
            final String aConstructionTypeName, final String aArticleName,
            final String aAttributeInfo, final Integer aNumberOfItems,
            final Date aLoadingDate, final Colli aColli,
            final String someTransportDetails, final String aComment,
            final Integer aTransportYear, final Integer aTransportWeek,
            final Integer aCustomerNr, final String aLoadTime,
            final Integer aPostShipmentId, final String aProductAreaGroupName,
            final Date actionStartedDate) {
        super();
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append(
                "orderLineId", orderLineId).append("customerDetails",
                customerDetails).append("orderNr", orderNr).append("address",
                address).append("info", info).append("constructionTypeName",
                constructionTypeName).append("articleName", articleName)
                .append("attributeInfo", attributeInfo).append("numberOfItems",
                        numberOfItems).append("loadingDate", loadingDate)
                .append("colli", colli).append("transportDetails",
                        transportDetails).append("comment", comment).append(
                        "transportYear", transportYear).append("transportWeek",
                        transportWeek).toString();
    }
