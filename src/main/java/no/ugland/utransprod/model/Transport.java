...
public class Transport extends BaseObject implements Comparable<Transport> {
	 ...
	 * @param loadTime
	 */
	public Transport(Integer transportId, Integer transportYear, Integer transportWeek, Date loadingDate,
			Set<Order> orders, String transportName, Date sent, Set<PostShipment> postShipments, Supplier supplier,
			Employee employee, String loadTime, final String aTrolley, String aTransportComment) {
		super();
	...
	public boolean equals(final Object other) {
		...
		return new EqualsBuilder().append(transportId, castOther.transportId).isEquals();
	}
		...
		if (orders != null) {
			for (Order order : orders) {
				if (order.getProductArea() != null
						&& order.getProductArea().getProductAreaGroup().equals(productAreaGroup)
						|| productAreaGroup.getProductAreaGroupName().equals("Alle")) {
					orderList.add(order);
				}
			}
		}
	...
	public int compareTo(final Transport other) {
		return new CompareToBuilder().append(transportYear, other.transportYear)
				.append(transportWeek, other.transportWeek).append(transportName, other.transportName).toComparison();
	}
	...
	public void setLevert(Date levertDato) {
		this.levert = levertDato;
	}
