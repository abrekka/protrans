...
public class EmployeeType extends BaseObject {
	...
	public boolean equals(final Object other) {
		if (!(other instanceof EmployeeType))
			return false;
		EmployeeType castOther = (EmployeeType) other;
		return new EqualsBuilder().append(employeeTypeName,
				castOther.employeeTypeName).isEquals();
	}
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append(
				"employeeTypeName", employeeTypeName).toString();
	}
}
