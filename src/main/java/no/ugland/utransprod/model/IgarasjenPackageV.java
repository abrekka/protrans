...
public class IgarasjenPackageV extends BaseObject implements TextRenderable, PackableListItem {
	...
	public IgarasjenPackageV() {
		super();

	}

	public IgarasjenPackageV(final Integer aOrderLineId, final String someCustomerDetails, final String aOrderNr,
			final String aAddress, final String someInfo, final String aConstructionTypeName, final String aArticleName,
			final String aAttributeInfo, final Integer aNumberOfItems, final Date aLoadingDate, final Colli aColli,
			final String someTransportDetails, final String aComment, final Integer aTransportYear,
			final Integer aTransportWeek, final Integer aCustomerNr, final String aLoadTime,
	...
	public boolean equals(final Object other) {
		if (!(other instanceof IgarasjenPackageV))
			return false;
		IgarasjenPackageV castOther = (IgarasjenPackageV) other;
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("orderLineId", orderLineId)
				.append("customerDetails", customerDetails).append("orderNr", orderNr).append("address", address)
				.append("info", info).append("constructionTypeName", constructionTypeName)
				.append("articleName", articleName).append("attributeInfo", attributeInfo)
				.append("numberOfItems", numberOfItems).append("loadingDate", loadingDate).append("colli", colli)
				.append("transportDetails", transportDetails).append("comment", comment)
	...
	public String getOrderString() {
		...
		buffer.append(" - ").append(orderNr).append("\n").append(address).append(" ,").append(constructionTypeName)
				.append(",").append(info);
