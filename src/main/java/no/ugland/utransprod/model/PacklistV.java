...
public class PacklistV extends BaseObject implements Comparable<PacklistV>, TextRenderable, Applyable {
    ...
    public PacklistV(Integer orderId, Integer customerNr, String customerDetails, String orderNr, String address, String info,
	    String constructionTypeName, Date loadingDate, Date packlistReady, String comment, Integer numberOfTakstol, Integer hasGulvspon,
	    Integer numberOfGulvspon, String productAreaGroupName, final String someTransportDetails) {
	super();
	...
	return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("orderId", orderId).append("customerNr", customerNr)
		.append("customerDetails", customerDetails).append("orderNr", orderNr).append("address", address).append("info", info)
		.append("constructionTypeName", constructionTypeName).append("loadingDate", loadingDate).append("packlistReady", packlistReady)
