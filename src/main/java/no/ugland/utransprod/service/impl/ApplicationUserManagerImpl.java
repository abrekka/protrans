 ...
 * @author atle.brekka
 */
public class ApplicationUserManagerImpl extends ManagerImpl<ApplicationUser>
		implements ApplicationUserManager {
	private JobFunctionManager jobFunctionManager;

	/**
	 * @param aJobFunctionManager
	 */
	public final void setJobFunctionManager(
			final JobFunctionManager aJobFunctionManager) {
	 ...
	 *      java.lang.String)
	 */
	public final ApplicationUser login(final String userName,
			final String password) {
		List<ApplicationUser> users = ((ApplicationUserDAO) dao)
