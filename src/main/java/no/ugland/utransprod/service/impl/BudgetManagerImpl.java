...
public class BudgetManagerImpl extends ManagerImpl<Budget>implements BudgetManager {
     ...
     */
    public final List<Budget> findByYearAndWeek(final Integer year, final Integer week,
            final Integer notId, final ProductArea productArea,final BudgetType budgetType) {
     ...
     */
    public final Budget findByYearAndWeek(final Integer year, final Integer week,
            final ProductArea productArea,BudgetType budgetType) {
     ...
     */
    public final Budget findByYearAndWeekPrProductAreaGroup(final Integer year, final Integer week,
            final ProductAreaGroup productAreaGroup,BudgetType budgetType) {
        return productAreaGroup.getProductAreaGroupName().length() != 0 ? ((BudgetDAO)dao)
                .findByYearAndWeekPrProductAreaGroup(year, week, productAreaGroup,budgetType) : ((BudgetDAO)dao).findByYearAndWeek(
	...
	public Budget findSumPrProductAreaAndPeriode(Periode periode,
	...
	public Budget findByYearAndSalesman(Integer year, String salesman,
			ProductArea productArea, BudgetType budgetType) {
