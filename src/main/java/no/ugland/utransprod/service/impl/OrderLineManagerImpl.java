 ...
 * @author atle.brekka
 */
public class OrderLineManagerImpl extends AbstractApplyListManager<PackableListItem> implements
        OrderLineManager {
     ...
     */
    public final List<Order> findByConstructionTypeArticleAttributes(final List<OrderLine> criterias,
     ...
     *      java.lang.String)
     */
    public final List<OrderLine> findUnproducedByOrderNrAndArticleName(final String orderNr,
     ...
     *      java.lang.String)
     */
    public final List<OrderLine> findUnpackedByOrderNrAndArticleName(final String orderNr,
            final String articleName) {
        ArticleType articleType = articleTypeManager.findByName(articleName);
     ...
     *      java.lang.String)
     */
    public final List<OrderLine> findUnproducedByCustomerNrAndArticleName(final Integer customerNr,
            final String articleName) {
        ArticleType articleType = articleTypeManager.findByName(articleName);
     ...
     *      java.lang.String)
     */
    public final List<OrderLine> findUnpackedByCustomerNrAndArticleName(final Integer customerNr,
            final String articleName) {
        ArticleType articleType = articleTypeManager.findByName(articleName);
     ...
     */
    public final List<OrderLine> findByArticleAndAttribute(final String articleName,
     ...
     */
    public final List<OrderLine> findByOrderNrArticleNameAndAttribute(final String orderNr,
            final String articleName, final String attributeName, final String attributeValue) {
        ArticleType articleType = articleTypeManager.findByName(articleName);
        return orderLineDAO.findByOrderNrArticleNameAndAttribute(orderNr, articleType, attributeName,
                attributeValue);
    }
     ...
     *      java.lang.String, java.lang.String, java.lang.String)
     */
    public final List<OrderLine> findByCustomerNrArticleNameAndAttribute(final Integer customerNr,
            final String articleName, final String attributeName, final String attributeValue) {
        ArticleType articleType = articleTypeManager.findByName(articleName);
        return orderLineDAO.findByCustomerNrArticleNameAndAttribute(customerNr, articleType, attributeName,
                attributeValue);
    }
    ...
    private void setOwnProductionAndInternalCostTakstol(
			List<Order> orderBasisList) {
		for(Order order:orderBasisList){
			BigDecimal cstpr = ordlnManager.getSumCcstpr(order.getOrderNr(), takstolArticleType
	                .getProdCatNo());
