...
public class SumOrderReadyVManagerImpl implements SumOrderReadyVManager {
     ...
     * findByDateAndProductAreaGroupName(java.util.Date,
     *      java.lang.String)
     */
    public final SumOrderReadyV findByDateAndProductAreaGroupName(final Date date,
        ...
        return dao.findByDateAndProductAreaGroupName(DATE_FORMAT.format(date),
     ...
     */
    public final SumOrderReadyV findSumByWeekAndProductAreaGroupName(final Integer year,
            final Integer week, final String productAreaGroupName) {
        if (productAreaGroupName == null) {
            return findSumByWeek(year, week);
        }
        return dao.findSumByWeekAndProductAreaGroupName(year, week,
                productAreaGroupName);
    }
