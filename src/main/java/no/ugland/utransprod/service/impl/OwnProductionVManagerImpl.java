...
public class OwnProductionVManagerImpl implements OwnProductionVManager {
     ...
     */
    public final List<OwnProductionV> findByParams(
        ...
        } else if (params.getExcelReportType() == ExcelReportEnum.PACKLIST_NOT_READY) {
            return dao.findPacklistNotReady(params.getProductAreaName());
        } else if (params.getYear().equals(Util.getCurrentYear())
                && params.getWeekFrom().equals(Util.getCurrentWeek())) {
            return dao
    ...
    private enum OwnProductionReport{
        ...
        OWN_PRODUCTION_PACKLIST_NOT_READY {
            ...
            public List<OwnProductionV> findByParams(final OwnProductionVDAO dao,final ExcelReportSetting params) {
                if (params.getYear().equals(Util.getCurrentYear())
                        && params.getWeekFrom().equals(Util.getCurrentWeek())) {
                return dao.findPacklistNotReady(params.getProductAreaName(),((ExcelReportSettingOwnProduction) params)
                        .getProductAreaGroupName());
                }
                return null;
            }
