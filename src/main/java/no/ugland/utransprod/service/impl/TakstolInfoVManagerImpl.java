...
public class TakstolInfoVManagerImpl implements TakstolInfoVManager {
    ...
    public List<Object[]> getBeregnetTidForOrdre(String fraAarUke, String tilAarUke, TransportConstraintEnum transportConstraintEnum,
	    String productArea) {
	return dao.getBeregnetTidForOrdre(fraAarUke, tilAarUke, transportConstraintEnum, productArea);
    }
