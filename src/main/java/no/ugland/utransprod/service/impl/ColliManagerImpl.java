 ...
 * @author atle.brekka
 */
public class ColliManagerImpl extends ManagerImpl<Colli> implements
		ColliManager {
	/**
	 * @see no.ugland.utransprod.service.ColliManager#findByNameAndOrder(java.lang.String,
	 *      no.ugland.utransprod.model.Order)
	 */
	public final Colli findByNameAndOrder(final String colliName,
			final Order order) {
	...
	/**
	 * @see no.ugland.utransprod.service.ColliManager#lazyLoadColli(no.ugland.utransprod.model.Colli,
	 *      no.ugland.utransprod.service.enums.LazyLoadColliEnum[])
	 */
	/*
	 * public final void lazyLoadColli(final Colli colli, final
	 * LazyLoadColliEnum[] enums) { dao.lazyLoadColli(colli, enums);
	 * 
	 * }
	 */
	 ...
	 */
	public final Colli findByNameAndPostShipment(final String colliName,
			final PostShipment postShipment) {
		return ((ColliDAO) dao).findByNameAndPostShipment(colliName,
				postShipment);
	}
