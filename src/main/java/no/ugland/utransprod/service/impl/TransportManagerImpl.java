 ...
 * @author atle.brekka
 */
public class TransportManagerImpl extends ManagerImpl<Transport> implements
		TransportManager {
	...
	public final List<Transport> findBetweenYearAndWeek(final Integer year,
		...
		return ((TransportDAO) dao).findBetweenYearAndWeek(year, fromWeek,
				toWeek, orderBy);
	}
	...
	public final List<Transport> findByYearAndWeekAndProductAreaGroup(
		...
		return ((TransportDAO) dao).findByYearAndWeekAndProductAreaGroup(year,
				week, productAreaGroup);
	}
	...
	public final List<Transport> findInPeriode(final Periode periode,
		...
		return ((TransportDAO) dao)
				.findInPeriode(periode, productAreaGroupName);
	}
