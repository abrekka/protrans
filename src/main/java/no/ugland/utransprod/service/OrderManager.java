...
public interface OrderManager extends OverviewManager<Order>, ExcelManager {
     ...
     */
    List<ReportDataTransport> countOrderAndCosts(String fromString, String toString, TransportConstraintEnum transportConstraintEnum,
     ...
     */
    List<ReportDataTransport> getOrdersAndCosts(String fromString, String toString, TransportConstraintEnum transportConstraintEnum,
	    ProductArea productArea);
