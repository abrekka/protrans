...
public class ManagerRepositoryImpl implements ManagerRepository {
	...
	@Inject
	public ManagerRepositoryImpl(ArticleTypeManager aArticleTypeManager,
			...
			IntelleVManager aIpkOrdManager,
			...
			FrontProductionVManager frontProductionVManager) {
