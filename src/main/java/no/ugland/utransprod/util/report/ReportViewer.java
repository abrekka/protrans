...
public class ReportViewer extends JDialog implements Closeable {
     ...
     */
    public final void generateProtransReport(final TableModel tableModel, final String heading, final ReportEnum reportEnum,
    ...
    public final void generateProtransReportFromBeanAndShow(final Collection<?> beans, final String heading, final ReportEnum reportEnum,
	    final Map<String, Object> extraParams, final String reportFileName, final WindowInterface window, final boolean isModal)
	    throws ProTransException {
    ...
    public final void generateProtransReportAndShow(final TableModel tableModel, final String heading, final ReportEnum reportEnum,
	    final Map<String, Object> extraParams, final WindowInterface window) throws ProTransException {
     ...
     * @throws ProTransException
     */
    public final void generateProtransReportFromBean(final Collection<?> beans, final String heading, final ReportEnum reportEnum,
	    final Map<String, Object> extraParams, final String reportFileName) throws ProTransException {
    ...
    private void generateReport(final String reportFile, final JRDataSource datasource, final String heading, final Map<String, Object> parameters,
	    final boolean printable) throws ProTransException {
	try {
    ...
    private void generateProtransReportFromDatasource(final JRDataSource datasource, final String heading, final ReportEnum reportEnum,
	    final Map<String, Object> extraParams) throws ProTransException {
    ...
    private void addLogoToParameters(final ReportEnum reportEnum, Map<String, Object> parameters, final Map<String, Object> extraParams) {
	...
	try {
	    ...
	    MailUtil.sendMailWithAttachmentDesktop(mailConfig.getToMailAddress(), mailConfig.getHeading(), mailConfig.getMsg(), tempFileName);
