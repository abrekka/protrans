...
public class SaleReportSum implements Serializable {
    ...
    public SaleReportSum(final Integer aOrderCount, final BigDecimal aSumOwnProduction, final BigDecimal aSumTransport,
	    final BigDecimal aSumAssembly, final BigDecimal aSumYesLines, final BigDecimal aSumDb, final String aCountyName) {
	super();
    ...
    public SaleReportSum(final Integer aOrderCount, final BigDecimal aSumOwnProduction, final BigDecimal aSumTransport,
	    final BigDecimal aSumAssembly, final BigDecimal aSumYesLines, final BigDecimal aSumDb, final String aCountyName, final String aSalesman) {
	super();
	this.orderCount = aOrderCount;
	this.sumOwnProduction = aSumOwnProduction;
	this.sumTransport = aSumTransport;
    ...
    public SaleReportSum(final Long aOrderCount, final BigDecimal aSumOwnProduction, final BigDecimal aSumTransport, final BigDecimal aSumAssembly,
	    final BigDecimal aSumYesLines, final BigDecimal aSumDb) {
	super();
