...
public class SaleReportSum implements Serializable {
	...
	public SaleReportSum() {
		...
		this.sumAreal = BigDecimal.ZERO;
	}

	public SaleReportSum(final Integer aOrderCount, final BigDecimal aSumOwnProduction, final BigDecimal aSumTransport,
			final BigDecimal aSumAssembly, final BigDecimal aSumYesLines, final BigDecimal aSumDb,
			final String aCountyName, final BigDecimal aSumAreal) {
		super();
		...
		this.sumAreal = aSumAreal;
	}

	public SaleReportSum(final Integer aOrderCount, final BigDecimal aSumOwnProduction, final BigDecimal aSumTransport,
			final BigDecimal aSumAssembly, final BigDecimal aSumYesLines, final BigDecimal aSumDb,
			final String aCountyName, final String aSalesman,final BigDecimal aSumAreal) {
		super();
		this.orderCount = aOrderCount;
		this.sumOwnProduction = aSumOwnProduction;
		this.sumTransport = aSumTransport;
	...
	public SaleReportSum(final Integer aOrderCount, final BigDecimal aSumOwnProduction, final BigDecimal aSumTransport,
			final BigDecimal aSumAssembly, final BigDecimal aSumYesLines, final BigDecimal aSumDb,final BigDecimal aSumAreal) {
		super();
		this.orderCount = aOrderCount;
		this.sumOwnProduction = aSumOwnProduction;
		this.sumTransport = aSumTransport;
	...
	public SaleReportSum(final Long aOrderCount, final BigDecimal aSumOwnProduction, final BigDecimal aSumTransport,
			final BigDecimal aSumAssembly, final BigDecimal aSumYesLines, final BigDecimal aSumDb,final BigDecimal aSumAreal) {
		super();
	...
	public BigDecimal getSumAreal() {
		return sumAreal;
	}
	public void setSumAreal(BigDecimal sumAreal) {
		this.sumAreal = sumAreal;
	}
	...
	public boolean equals(final Object other) {
		...
		return new EqualsBuilder().append(countyName, castOther.countyName).isEquals();
	}
	...
	public void addSumAreal(BigDecimal areal){
		this.sumAreal=sumAreal.add(areal==null?BigDecimal.ZERO:areal);
	}
