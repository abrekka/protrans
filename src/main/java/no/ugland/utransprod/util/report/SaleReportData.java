...
public class SaleReportData implements Comparable<SaleReportData> {
	...
	public SaleReportData(int probability, String countyName, String salesman, String customerNr, String customerName,
			String orderNr, BigDecimal ownProductionCost, BigDecimal transportCost, BigDecimal assemblyCost,
			BigDecimal yesLines, BigDecimal db, Date aSalesDate, Date aRegsiteredDate, Integer aOrderDate,
			BigDecimal aContributionMargin, Integer productAreaNr, String segmentNo, BigDecimal areal) {
		super();
	...
	public SaleReportData(String type, String countyName, String salesman, String customerNr, String customerName,
			String orderNr, BigDecimal ownProductionCost, BigDecimal transportCost, BigDecimal assemblyCost,
			BigDecimal yesLines, BigDecimal db, BigDecimal dg, Date aSalesDate, Integer productAreaNr, String segmentNo,
			BigDecimal areal) {
		super();
		this.type = type;
		this.countyName = countyName;
	...
	public boolean equals(final Object other) {
		...
		return new EqualsBuilder().append(orderNr, castOther.orderNr).append(probabilityEnum, castOther.probabilityEnum)
				.isEquals();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(orderNr).append(probabilityEnum).toHashCode();
	}

	public BigDecimal getContributionMargin() {
		return contributionMargin != null ? contributionMargin : BigDecimal.ZERO;
	}
