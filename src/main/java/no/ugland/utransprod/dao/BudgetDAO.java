...
public interface BudgetDAO extends DAO<Budget> {
    ...
    Budget findSumPrProductAreaAndPeriode(Periode periode, ProductArea productArea, BudgetType budgetType);

    Budget findByYearAndSalesman(Integer year, String salesman, ProductArea productArea, BudgetType budgetType);
