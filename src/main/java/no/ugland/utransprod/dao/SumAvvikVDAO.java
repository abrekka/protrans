...
public interface SumAvvikVDAO extends DAO<SumAvvikV> {
	 ...
	 * @return avvik
	 */
	List<SumAvvikV> findByProductAreaYearAndMonth(Integer year, Integer month,
			String productArea);
	 ...
	 * @return avvik
	 */
	List<SumAvvikV> findSumByProductAreaYearAndMonth(Integer year,
			Integer month, String productArea);
	 ...
	 * @return avvik
	 */
	List<SumAvvikV> findByProductAreaYearAndMonthWithClosed(Integer year,
			Integer month, String productArea);
}
