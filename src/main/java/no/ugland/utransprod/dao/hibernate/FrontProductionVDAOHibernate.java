 ...
 * 
 */
public class FrontProductionVDAOHibernate extends
		BaseDAOHibernate<FrontProductionV> implements FrontProductionVDAO {
		...
		return (List<Produceable>) getHibernateTemplate().execute(
				new HibernateCallback() {
					...
					public Object doInHibernate(Session session)
						...
						return session.createCriteria(FrontProductionV.class)
	...
	public void refresh(Produceable frontProductionV) {
		...
		getHibernateTemplate().load(frontProductionV,
				frontProductionV.getOrderLineId());
	...
	@SuppressWarnings("unchecked")
	public List<Produceable> findByCustomerNrProductAreaGroup(
