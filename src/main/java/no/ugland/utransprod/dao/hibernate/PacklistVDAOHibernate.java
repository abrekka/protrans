 ...
 *
 */
public class PacklistVDAOHibernate extends
		BaseDAOHibernate<PacklistV> implements PacklistVDAO {
	...
	public List<PacklistV> findAll() {
		return getHibernateTemplate().find(
				"from PacklistV order by loadingDate");
	}
	...
	public void refresh(PacklistV packlistV) {
		...
		getHibernateTemplate().load(packlistV,
				packlistV.getOrderId());
	...
	public List<PacklistV> findByCustomerNrAndProductAreaGroup(
	...
	public List<PacklistV> findByOrderNrAndProductAreaGroup(final String orderNr,
