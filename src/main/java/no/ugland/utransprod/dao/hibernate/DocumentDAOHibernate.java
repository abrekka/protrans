...
public class DocumentDAOHibernate extends BaseDAOHibernate<Document> implements
        DocumentDAO {
                ...
                new HibernateCallback() {
                    ...
                    public Object doInHibernate(final Session session) {
                        ...
                        String sql = "select distinct document.documentId"
                                ...
                                +"                appointment.taskIdx=doctmpl.doctmplId and " +
                                        "         doctmpl.doctmplId in(102,103,153,154) and " +
                                        "         document.registered between :startDate and :endDate";
