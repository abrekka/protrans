...
public interface NokkelProduksjonVDAO extends DAO<NokkelProduksjonV> {
     ...
     * @return nøkkeltall
     */
    List<NokkelProduksjonV> findByYearWeekProductArea(Integer year,
            Integer weekFrom, Integer weekTo, String productAreaName);
     ...
     * @return nøkkeltall for produksjon
     */
    List<NokkelProduksjonV> findBetweenYearWeek(YearWeek fromYearWeek,
     ...
     */
    NokkelProduksjonV aggreagateYearWeek(YearWeek currentYearWeek,
            String productArea);

    List<NokkelProduksjonV> findByYearWeekProductAreaGroup(Integer year,
            Integer weekFrom, Integer weekTo, String productAreaGroupName);
}
