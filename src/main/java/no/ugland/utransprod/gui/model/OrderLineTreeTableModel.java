...
public class OrderLineTreeTableModel<T, E> extends DefaultTreeTableModel {
     ...
     * @param aObject
     */
    public OrderLineTreeTableModel(OrderWrapper<T, E> aObject) {
        super(new OrderLineTreeNode(aObject, null));
        ...
        case 1:
            if (treeNode.isLeaf()) {
                if (obj instanceof OrderLineAttributeCriteria) {
                    return Util.nullToString(((OrderLineAttributeCriteria) obj)
                            .getAttributeValueFrom())
                            + "-"
                            + Util
                                    .nullToString(((OrderLineAttributeCriteria) obj)
                                            .getAttributeValueTo());
                }
                ...
                /*
                 * if (((OrderLine) obj).getNumberOfItems() != null) { return
                 * decimalFormat.format(((OrderLine) obj) .getNumberOfItems()); }
                 */
                StringBuilder returnString = new StringBuilder();
                if (((OrderLine) obj).getNumberOfItems() != null) {
                    returnString.append(decimalFormat.format(((OrderLine) obj)
                            .getNumberOfItems()));
    ...
    public void fireChanged() {
        setRoot(new OrderLineTreeNode(orderWrapper, null));
    }
