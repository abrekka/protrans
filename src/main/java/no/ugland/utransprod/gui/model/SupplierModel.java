...
public class SupplierModel extends AbstractModel<Supplier, SupplierModel> {
	...
	firePropertyChange(PROPERTY_SUPPLIER_DESCRIPTION, oldDesc, supplierDescription);
    }
	...
	String oldSupplierNr = getSupplierNr();
	object.setSupplierNr(supplierNr);
	firePropertyChange(PROPERTY_SUPPLIER_NR, oldSupplierNr, supplierNr);
    }
	...
	if (supplierProductAreaGroupList != null) {
	    this.supplierProductAreaGroups = new ArrayList<SupplierProductAreaGroup>(supplierProductAreaGroupList);
	} else {
	    this.supplierProductAreaGroups.clear();
	}
	firePropertyChange(PROPERTY_SUPPLIER_PRODUCT_AREA_GROUPS_LIST, oldGroups, supplierProductAreaGroupList);
    }
	...
	presentationModel.getBufferedModel(PROPERTY_SUPPLIER_NAME).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_SUPPLIER_DESCRIPTION).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_PHONE).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_FAX).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_SUPPLIER_NR).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_ADDRESS).addValueChangeListener(listener);
	...
	presentationModel.getBufferedModel(PROPERTY_SUPPLIER_TYPE).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_INACTIVE_BOOL).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_SUPPLIER_PRODUCT_AREA_GROUPS_LIST).addValueChangeListener(listener);
    }
	...
	supplierModel.setSupplierId((Integer) presentationModel.getBufferedValue(PROPERTY_SUPPLIER_ID));
	supplierModel.setSupplierName((String) presentationModel.getBufferedValue(PROPERTY_SUPPLIER_NAME));
	supplierModel.setSupplierDescription((String) presentationModel.getBufferedValue(PROPERTY_SUPPLIER_DESCRIPTION));
	supplierModel.setPhone((String) presentationModel.getBufferedValue(PROPERTY_PHONE));
	supplierModel.setFax((String) presentationModel.getBufferedValue(PROPERTY_FAX));
	supplierModel.setSupplierNr((String) presentationModel.getBufferedValue(PROPERTY_SUPPLIER_NR));
	supplierModel.setAddress((String) presentationModel.getBufferedValue(PROPERTY_ADDRESS));
	supplierModel.setPostalCode((String) presentationModel.getBufferedValue(PROPERTY_POSTAL_CODE));
	supplierModel.setPostOffice((String) presentationModel.getBufferedValue(PROPERTY_POST_OFFICE));
	supplierModel.setSupplierType((SupplierType) presentationModel.getBufferedValue(PROPERTY_SUPPLIER_TYPE));
	supplierModel.setInactiveBool((Boolean) presentationModel.getBufferedValue(PROPERTY_INACTIVE_BOOL));
	...
	if (supplierProductAreaGroups != null) {
	    Set<SupplierProductAreaGroup> groups = object.getSupplierProductAreaGroups();
	    if (groups == null) {
