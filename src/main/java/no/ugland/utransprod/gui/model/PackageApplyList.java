...
public class PackageApplyList extends AbstractApplyList<PackableListItem> {
    ...
    public PackageApplyList(Login login, IApplyListManager<PackableListItem> manager, String aColliName, String aWindowAccessName,
	    ReportEnum aReportEnum, VismaFileCreator vismaFileCreator, ManagerRepository aManagerRepository) {
    ...
    protected OrderLine handleApply(final boolean applied, final WindowInterface window, final OrderLineManager orderLineManager,
    ...
    private void setObjectUnapplied(final OrderLineManager orderLineManager, final OrderLine orderLine) throws ProTransException {
	orderLine.setColli(null);
	orderLineManager.saveOrderLine(orderLine);
	checkCompleteness(orderLine, false);
    }

    private OrderLine setObjectApplied(final OrderLineManager orderLineManager, final OrderLine orderLine, final String aColliName)
