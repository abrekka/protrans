...
public class OrderModel extends AbstractOrderModel<Order, OrderModel> {
     ...
     * @param statusChange
     */
    public OrderModel(final Order order, final boolean search, final boolean changeInfo, final boolean statusChange, final String aProjectNr,
	...
	if (orderLines != null) {
		...
		orderLine.getConstructionTypeArticle(), orderLine.getArticleType(), cloneOrderLineAttributes(orderLine.getOrderLineAttributes()),
			orderLine.getOrderLineRef(), cloneOrderLines(// order,
			orderLine.getOrderLines()), orderLine.getNumberOfItems(), orderLine.getDialogOrder(), orderLine.getProduced(), orderLine
				.getArticlePath(), orderLine.getColli(), orderLine.getHasArticle(), orderLine.getAttributeInfo(), orderLine
				.getIsDefault(), orderLine.getPostShipment(), orderLine.getExternalOrderLine(), orderLine.getDeviation(), orderLine
				.getActionStarted(), orderLine.getProductionUnit(), orderLine.getOrdNo(), orderLine.getLnNo()));
	...
	if (attributes != null) {
		...
		clonedAttributes.add(new OrderLineAttribute(attribute.getOrderLineAttributeId(), attribute.getOrderLine(), attribute
			.getConstructionTypeArticleAttribute(), attribute.getConstructionTypeAttribute(), attribute.getArticleTypeAttribute(),
	...
	return new OrderLine(orderLine.getOrderLineId(), order, orderLine.getConstructionTypeArticle(), orderLine.getArticleType(),
		orderLine.getOrderLineAttributes(), orderLine.getOrderLineRef(), orderLine.getOrderLines(), orderLine.getNumberOfItems(),
		orderLine.getDialogOrder(), orderLine.getProduced(), orderLine.getArticlePath(), orderLine.getColli(), orderLine.getHasArticle(),
		orderLine.getAttributeInfo(), orderLine.getIsDefault(), orderLine.getPostShipment(), orderLine.getExternalOrderLine(),
		orderLine.getDeviation(), orderLine.getActionStarted(), orderLine.getProductionUnit(), orderLine.getOrdNo(), orderLine.getLnNo());
    }
	...
	if (attributes != null) {
		...
		orderLineAttributes.add(new OrderLineAttribute(null, orderLine, null, null, articleTypeAttribute, "", null, articleTypeAttribute
