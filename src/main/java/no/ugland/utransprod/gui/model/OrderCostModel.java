...
public class OrderCostModel extends AbstractModel<OrderCost, OrderCostModel> {
	...
	return new YesNoInteger(object.getInclVat());// object.isInclVat();
    }
	...
	object.setInclVat(inclVat.getIntegerValue());
	...
	presentationModel.getBufferedModel(PROPERTY_ORDER_COST_ID).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_COST_TYPE).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_COST_UNIT).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_COST_AMOUNT).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_INCL_VAT).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_IS_INCL_VAT).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_SUPPLIER).addValueChangeListener(listener);
	presentationModel.getBufferedModel(PROPERTY_INVOICE_NR).addValueChangeListener(listener);
	...
	orderCostModel.setOrderCostId((Integer) presentationModel.getBufferedValue(PROPERTY_ORDER_COST_ID));
	orderCostModel.setCostType((CostType) presentationModel.getBufferedValue(PROPERTY_COST_TYPE));
	orderCostModel.setCostUnit((CostUnit) presentationModel.getBufferedValue(PROPERTY_COST_UNIT));
	orderCostModel.setCostAmount((BigDecimal) presentationModel.getBufferedValue(PROPERTY_COST_AMOUNT));
	orderCostModel.setInclVat((Integer) presentationModel.getBufferedValue(PROPERTY_INCL_VAT));
	orderCostModel.setIsInclVat((YesNoInteger) presentationModel.getBufferedValue(PROPERTY_IS_INCL_VAT));
	orderCostModel.setSupplier((Supplier) presentationModel.getBufferedValue(PROPERTY_SUPPLIER));
	orderCostModel.setInvoiceNr((String) presentationModel.getBufferedValue(PROPERTY_INVOICE_NR));
