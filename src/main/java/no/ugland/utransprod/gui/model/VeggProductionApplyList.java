...
public class VeggProductionApplyList extends ProductionApplyList {
	...
	protected void handleApply(Produceable object, boolean applied, WindowInterface window, String aColliName) {
		...
		/* 90 */ if (order != null) {
			...
			/*     */ try {
				...
				/* 100 */ String doneBy = null;
				OrderLine vegg;
				/* 101 */ for (Iterator var13 = vegger.iterator(); var13.hasNext(); this.managerRepository
						.getOrderLineManager().saveOrderLine(vegg)) {
					...
					/* 108 */ if (applied) {
						...
						/* 115 */ if (tidsbruk == null) {
							/* 116 */ tidsbruk = Tidsforbruk.beregnTidsforbruk(vegg.getActionStarted(),
									vegg.getProduced());
							/*     */ }
						/*     */
						/* 119 */ if (antall == 1 && window != null) {
							/* 120 */ editPacklistView = new EditPacklistView(this.login, false, tidsbruk,
									vegg.getDoneBy());
	...
	/*     */ private void lagFerdigmelding(Integer ordno, Integer lnno, boolean minus) {
		...
		/* 168 */ if (ordln != null && ordln.getPurcno() != null && ordln.getPurcno() != 0) {
			...
			/* 170 */ fillinjer.add(String.format(
					"H;;%s;;;;;;;;;;;;;;;;;;;;;;%s;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;4",
					ordln.getPurcno() != null ? ordln.getPurcno().toString() : "", ""));
			/*     */
			/* 172 */ List<Ordln> vegglinjer = this.managerRepository.getOrdlnManager()
					.findOrdLnByOrdNo(ordln.getPurcno());
			Iterator var7 = vegglinjer.iterator();
			/* 173 */ while (var7.hasNext()) {
