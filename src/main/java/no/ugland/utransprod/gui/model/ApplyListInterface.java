...
public interface ApplyListInterface<T extends Applyable> {
	 ...
	 */
	//List<T> doSearch(String orderNr, String customerNr)throws ProTransException;
	...
	//void setApplied(T object, boolean applied, WindowInterface window,List<T> relatedArticles);
	 ...
	 * @return tabellmodell
	 */
	TableModel getTableModelReport(ListModel listModel, JXTable table,
	...
	List<T> doSearch(String orderNr, String customerNr,
