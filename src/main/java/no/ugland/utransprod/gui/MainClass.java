...
public final class MainClass {
	...
	private void startUp(final Injector injector) {
		...
		applicationUserManager.lazyLoad(login.getApplicationUser(),
		...
		if (roles != null) {
			if (roles.size() > 1) {
				userRole = (UserRole) JOptionPane.showInputDialog(null, "Velg rolle", "Velg rolle",
						JOptionPane.QUESTION_MESSAGE, null, roles.toArray(), null);
