...
/**
 * Klasse som brukes sammen med JInternalFrameAdapter for å kunne brukes om
 * hverandre. Stort sett alle metoder her er metoder som kjøres direkte på den
...
public class JDialogAdapter implements WindowInterface {
    ...
    /**
     * Denne gjelder ikke for JDialog så her blir ingenting kjørt
