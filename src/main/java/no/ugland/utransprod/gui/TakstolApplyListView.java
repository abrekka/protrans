...
public class TakstolApplyListView extends ApplyListView<Produceable> {
	...
	comboBoxProductionUnit = ((TakstolProductionViewHandler) viewHandler).getComboBoxProductionUnit();
	buttonShowTakstolInfo = ((TakstolProductionViewHandler) viewHandler).getButtonShowTakstolInfo(window);
	buttonStartetKapping = ((TakstolProductionViewHandler) viewHandler).getButtonStartetKapping(window);
	buttonIkkeStartetKapping = ((TakstolProductionViewHandler) viewHandler).getButtonIkkeStartetKapping(window);
	buttonFerdigKappet = ((TakstolProductionViewHandler) viewHandler).getButtonFerdigKappet(window);
	buttonIkkeFerdigKappet = ((TakstolProductionViewHandler) viewHandler).getButtonIkkeFerdigKappet(window);
	...
	FormLayout layout = new FormLayout("10dlu,p,3dlu,p,3dlu,p,3dlu,40dlu,3dlu,55dlu,55dlu,55dlu,45dlu,35dlu,1dlu:grow,3dlu,p,10dlu,p,3dlu,p",
	...
	builder.add(ButtonBarFactory.buildCenteredBar(buttonRefresh, buttonCancel), cc.xyw(2, 11, 17));
