...
public class VeggProductionWindow extends AbstractProductionPackageWindow<Produceable> {
    ...
    @Inject
    public VeggProductionWindow(Login login, ManagerRepository aManagerRepository, DeviationViewHandlerFactory aDeviationViewHandlerFactory,
	...
	return new VeggProductionViewHandler(new VeggProductionApplyList(login, veggProductionVManager, null, "Vegg", null, managerRepository),
		"Veggproduksjon", login, articleType, managerRepository, deviationViewHandlerFactory, setProductionUnitActionFactory);
    }
