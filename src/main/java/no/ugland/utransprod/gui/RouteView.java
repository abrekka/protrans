...
public class RouteView implements Viewer {
	...
	FormLayout layout = new FormLayout("p,3dlu,p,3dlu,15dlu,3dlu,p,3dlu,35dlu,3dlu,28dlu,3dlu,35dlu,p,p,p,p", "p,3dlu,p");
	PanelBuilder builder = new PanelBuilder(layout);
	...
	builder.add(ButtonBarFactory.buildCenteredBar(buttonExcel, buttonSave, buttonRefresh, buttonCancel), cc.xy(2, 4));
	...
	return viewHandler.getOrderPanelView().buildPanel(window, "200", viewHandler.getRightClickListener(false), "240", true);
    }
