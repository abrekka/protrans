...
public class GavlProductionView extends ApplyListView<Produceable> {
	...
	public GavlProductionView(
			AbstractProductionPackageViewHandler<Produceable> aViewHandler) {
    ...
    public JComponent buildPanel(final WindowInterface window) {
        ...
        FormLayout layout = new FormLayout("10dlu,p,3dlu,p,3dlu,40dlu,3dlu,40dlu,3dlu,40dlu,"
                + viewHandler.getTableWidth() + ":grow,3dlu,p,10dlu,p,3dlu,p,10dlu",
