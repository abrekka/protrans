...
public class MenuBarBuilderImpl implements MenuBarBuilderInterface {
	...
	@Inject
	public MenuBarBuilderImpl(
			final RegisterAccidentAction aRegisterAccidentAction,
			final AdminDeviationAction aAdminDeviationAction,
			final RegisterDeviationAction aRegisterDeviationAction,
			...
			ImportSalesmanBudgetAction aImportSalesmanBudgetAction,TrossDrawReportAction aTrossDrawReportAction) {
	...
	private JMenu buildSystemMenu() {
		...
		addMenuItem(menuSystem, new SystemCloseAction(), KeyEvent.VK_A,
				...
				IconEnum.ICON_EXIT, null, null, false);
		return menuSystem;
	...
	private JMenu buildBasisMenu() {
		...
		addMenuItem(menuBasis, constructionTypeMasterAction, KeyEvent.VK_M,
				null, null, null, "Master garasjetype", false);
		addMenuItem(menuBasis, constructionTypeAction, KeyEvent.VK_K, null,
				null, null, "Konstruksjonstyper", false);
		addMenuItem(menuBasis, articleTypeAction, KeyEvent.VK_A, null, null,
				null, "Artikkel", false);
		addMenuItem(menuBasis, costTypeAction, KeyEvent.VK_K, null, null, null,
				"Kostnadstyper", false);
		addMenuItem(menuBasis, costUnitAction, KeyEvent.VK_E, null, null, null,
				"Kostnadsenheter", false);
		addMenuItem(menuBasis, jobFunctionAction, KeyEvent.VK_F, null, null,
				null, "Funksjon", false);
		addMenuItem(menuBasis, functionCategoryAction, KeyEvent.VK_K, null,
				null, null, "Kategori", false);
		addMenuItem(menuBasis, deviationStatusAction, KeyEvent.VK_G, null,
				null, null, "Avikstatus", false);
		addMenuItem(menuBasis, attributeAction, KeyEvent.VK_K, null, null,
				null, "Attributter", false);
		addMenuItem(menuBasis, supplierAction, KeyEvent.VK_L, null, null, null,
				"Leverandører", false);
		addMenuItem(menuBasis, supplierTypeAction, KeyEvent.VK_T, null, null,
				null, "Leverandørtyper", false);
		addMenuItem(menuBasis, importCountiesAction, KeyEvent.VK_F, null, null,
				null, "Importer fylker", false);
		addMenuItem(menuBasis, importAreasAction, KeyEvent.VK_K, null, null,
				null, "Importer kommuner", false);
		addMenuItem(menuBasis, importPostalCodesAction, KeyEvent.VK_I, null,
				null, null, "Importer gyldige postnummer", false);
		addMenuItem(menuBasis, updateTransportPricesAction, KeyEvent.VK_O,
				null, null, null, "Oppdater transportpriser", false);
		addMenuItem(menuBasis, importProductionBudgetAction, KeyEvent.VK_B,
				null, null, null, "Importer budsjettall", false);
		addMenuItem(menuBasis, importSnowloadAction, KeyEvent.VK_S, null, null,
				null, "Importer snølast", false);
		addMenuItem(menuBasis, importSaleBudgetAction, KeyEvent.VK_B, null,
				null, null, "Importer budsjettall", false);
		addMenuItem(menuBasis, importSalesmanBudgetAction, KeyEvent.VK_B, null,
				null, null, "Importer budsjettall selger", false);
		return menuBasis;
	}
	...
	private JMenu buildProductionMenu() {
		return productionMenu != null ? productionMenu.buildMenu()
				: new JMenu();
	}
	...
	private JMenu buildReportMenu() {
		...
		addMenuItem(menuSale, confirmReportAction, KeyEvent.VK_A, null, null,
				null, "Avropsrapport", false);
		addMenuItem(menuSale, new SalesReportAction(), KeyEvent.VK_G, null,
				null, null, "Salgsrapport", false);
		addMenuItem(menuSale, new SalesStatusReportAction(), KeyEvent.VK_T,
				null, null, null, "Salgsstatus", false);
		addMenuItem(menuSale, salesGoalReportAction, KeyEvent.VK_T, null, null,
				null, "Salgsmål", false);

		menuReport.add(menuSale);

		JMenu menuProject = addMenu("Drift og prosjektering", KeyEvent.VK_D);
		addMenuItem(menuProject, new PacklistNotReadyReportAction(),
				KeyEvent.VK_K, null, null, null, "Pakkliste ikke klar", false);
		addMenuItem(menuProject, new DrawReportAction(), KeyEvent.VK_T, null,
				null, null, "Tegningsrapport", false);
		...
		addMenuItem(menuProduction, new OwnProductionReportAction(),
				KeyEvent.VK_E, null, null, null, "Egenproduksjon", false);
		addMenuItem(menuProduction, new ProductivityReportAction(),
				KeyEvent.VK_P, null, null, null, "Produktivitet", false);
		addMenuItem(menuProduction, new TakstolOwnProductionReportAction(),
				KeyEvent.VK_I, null, null, null, "Internordre takstol", false);
		addMenuItem(menuProduction, takstolProductionUnitReportAction,
				KeyEvent.VK_J, null, null, null, "Jiggrapport", false);
		...
		addMenuItem(menuTransport, new PostShipmentSentReportAction(),
				KeyEvent.VK_R, null, null, null, "Ettersendinger sendt", false);
		addMenuItem(menuTransport, new TransportListReportAction(),
				KeyEvent.VK_A, null, null, null, "Transportert i periode",
				false);
		addMenuItem(menuTransport, new TransportOverviewReportAction(),
				KeyEvent.VK_O, null, null, null, "Transportoversikt", false);
		addMenuItem(menuTransport, new TransportReportAction(), KeyEvent.VK_T,
				null, null, null, "Transportstatistikk", false);
		menuReport.add(menuTransport);

		JMenu menuAdm = addMenu("Adm. og økonomi", KeyEvent.VK_A);
		addMenuItem(menuAdm, new InvoiceReportAction(), KeyEvent.VK_I, null,
				null, null, "Ikke fakturert", false);
		addMenuItem(menuAdm, new KeyReportAction(), KeyEvent.VK_N, null, null,
				null, "Nøkkeltall", false);
		addMenuItem(menuAdm, new OrderStatusReportAction(), KeyEvent.VK_S,
				null, null, null, "Status alle ordre ikke sendt", false);
		addMenuItem(menuAdm, new ReadyCountReportAction(), KeyEvent.VK_L, null,
				null, null, "Telleliste", false);
		menuReport.add(menuAdm);

		JMenu menuDeviation = addMenu("Avvik", KeyEvent.VK_V);
		addMenuItem(menuDeviation, new DeviationReportAction(), KeyEvent.VK_V,
				null, null, null, "Avvik", false);
		addMenuItem(menuDeviation, new SummaryReportDeviationAction(),
				KeyEvent.VK_J, null, null, null,
				"Avvik - Skjema gjennomgåelse", false);
		addMenuItem(menuDeviation, new DeviationFunctionReportAction(),
				KeyEvent.VK_V, null, null, null, "Avvik pr aviksfunksjon",
				false);
	...
	private JMenu buildDeviationMenu() {
		JMenu menuDeviation = addMenu("Avvik", KeyEvent.VK_V);
		addMenuItem(menuDeviation, registerDeviationAction, KeyEvent.VK_R,
				null, null, null, null, true);
		addMenuItem(menuDeviation, adminDeviationAction, KeyEvent.VK_A, null,
				null, null, "Avvik", false);
		addMenuItem(menuDeviation, registerAccidentAction, KeyEvent.VK_U, null,
				null, null, null, true);
		addMenuItem(menuDeviation, adminAccidentAction, KeyEvent.VK_A, null,
				null, null, "Ulykke", false);
	...
	private JMenu buildHelpMenu() {
		...
		addMenuItem(menuHelp, new HelpAction(), KeyEvent.VK_J, null, null,
				null, null, false).addActionListener(
				new CSH.DisplayHelpFromSource(mainHB));
		addMenuItem(menuHelp, new OpenSupportAction(), KeyEvent.VK_S, null,
				null, null, null, false);
		addMenuItem(menuHelp, new ShowInfoAction(), KeyEvent.VK_I, null, null,
				null, null, false);
		return menuHelp;
	}
	 ...
	 * @return menylinje
	 */
	public final JMenuBar buildMenuBar(final ProTransMain parentFrame,
	 ...
	 * @return menyvalg
	 */
	private JMenuItem addMenuItem(final JMenu menu,
	...
	private JMenuItem addMenuItem(final JMenu menu,
		...
		if (menuItemAction != null) {
			...
			if (adminOnly) {
				if (Util.convertNumberToBoolean(login.getUserType()
						.getIsAdmin())) {
				...
				if (windowName != null) {
					if (writeAccess) {
						if (UserUtil.hasWriteAccess(login.getUserType(),
								windowName)) {
							menuItem.setEnabled(true);
						}
					} else {
	 ...
	 * @param windowEnum
	 */
	final void openFrame(final WindowInterface window,
	 ...
	 * 
	 * public ImportBudgetAction() {
	 * super("Importer budsjettall produksjon..."); }
	 * 
	...
	private class TransportOverviewReportAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent arg0) {
			...
			TransportOverviewReportHandler transportOverviewReportHandler = new TransportOverviewReportHandler(
					steinChecker);
			openFrame(new TransportOverviewReport(
					transportOverviewReportHandler));
	...
	private class TakstolOwnProductionReportAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent arg0) {
			ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(
					ExcelReportEnum.TAKSTOL_OWN_ORDER_REPORT, new Dimension(
							320, 110));
			openFrame(new ExcelReportView(excelReportViewHandler, false));
	...
	private class PostShipmentSentReportAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent arg0) {
			ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(
					ExcelReportEnum.POST_SHIPMENT_SENT_COUNT, new Dimension(
							320, 130));
			openFrame(new ExcelReportView(excelReportViewHandler, false));
	...
	private class DeviationFunctionReportAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent arg0) {
			ExcelReportViewHandlerDeviation excelReportViewHandler = new ExcelReportViewHandlerDeviation(
					"Avvik pr aviksfunksjon", true,
					ExcelReportEnum.DEVIATION_JOB_FUNCTION_SUM);
			openFrame(new ExcelReportView(excelReportViewHandler, false));
	...
	private class TransportListReportAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent arg0) {
			ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(
					ExcelReportEnum.TRANSPORT_LIST, new Dimension(320, 130));
			openFrame(new ExcelReportView(excelReportViewHandler, false));
	...
	private class InvoiceReportAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent arg0) {
			ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(
					ExcelReportEnum.PRODUCTIVITY_LIST_NOT_INVOICED,
	...
	private class OrderStatusReportAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent arg0) {
			ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(
					ExcelReportEnum.PRODUCTIVITY_ORDER_STATUS, new Dimension(
							250, 110));
			openFrame(new ExcelReportView(excelReportViewHandler, false));
		}
	}
	...
	private class ReadyCountReportAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent arg0) {
			ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(
					ExcelReportEnum.READY_COUNT, new Dimension(250, 110));
			openFrame(new ExcelReportView(excelReportViewHandler, false));
		}
	}
	...
	private class ShowInfoAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent arg0) {
			if (MainClass.version == null) {
				ResourceBundle configuration = ResourceBundle
						.getBundle("Configuration");

				MainClass.version = configuration.getString("version");
			}
			Util.showMsgFrame(ProTransMain.PRO_TRANS_MAIN.getContentPane(),
					"ProTrans", "Versjon " + MainClass.version);
	...
	private class CascadeWindows extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent arg0) {
			...
			int frameDistance = proTransMain.getHeight()
					- proTransMain.getContentPane().getHeight();
			...
			for (int i = 0; i < frames.length; i++) {
				if (!frames[i].isIcon()) {
					try {
						...
						if (x + width > proTransMain.getContentPane()
								.getWidth()) {
							x = 0;
						}
						if (y + height > proTransMain.getContentPane()
								.getHeight()) {
							y = 0;
						}
						frames[i].toFront();
	...
	final void showSupportPage() {
		try {
			...
			e.printStackTrace();
			Util.showErrorMsgFrame(ProTransMain.PRO_TRANS_MAIN, "Feil", e
					.getMessage());
