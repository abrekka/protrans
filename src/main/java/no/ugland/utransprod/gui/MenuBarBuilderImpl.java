...
public class MenuBarBuilderImpl implements MenuBarBuilderInterface {
    ...
    @Inject
    public MenuBarBuilderImpl(final RegisterAccidentAction aRegisterAccidentAction, final AdminDeviationAction aAdminDeviationAction,
	...
	addMenuItem(menuSystem, new SystemCloseAction(), KeyEvent.VK_A, KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.ALT_MASK),
	...
	addMenuItem(menuBasis, constructionTypeMasterAction, KeyEvent.VK_M, null, null, null, "Master garasjetype", false);
	...
	addMenuItem(menuBasis, importPostalCodesAction, KeyEvent.VK_I, null, null, null, "Importer gyldige postnummer", false);
	addMenuItem(menuBasis, updateTransportPricesAction, KeyEvent.VK_O, null, null, null, "Oppdater transportpriser", false);
	addMenuItem(menuBasis, importProductionBudgetAction, KeyEvent.VK_B, null, null, null, "Importer budsjettall", false);
	...
	addMenuItem(menuTransport, new PostShipmentSentReportAction(), KeyEvent.VK_R, null, null, null, "Ettersendinger sendt", false);
	addMenuItem(menuTransport, new TransportListReportAction(), KeyEvent.VK_A, null, null, null, "Transportert i periode", false);
	addMenuItem(menuTransport, new TransportOverviewReportAction(), KeyEvent.VK_O, null, null, null, "Transportoversikt", false);
	addMenuItem(menuTransport, new TransportReportAction(), KeyEvent.VK_T, null, null, null, "Transportstatistikk", false);
	...
	addMenuItem(menuAdm, new OrderStatusReportAction(), KeyEvent.VK_S, null, null, null, "Status alle ordre ikke sendt", false);
     ...
     * @return menylinje
     */
    public final JMenuBar buildMenuBar(final ProTransMain parentFrame, final ApplicationUser aApplicationUser, final UserType currentUserType) {
	if (menuBar == null) {
     ...
     * @return menyvalg
     */
    private JMenuItem addMenuItem(final JMenu menu, final Action menuItemAction, final int keyEvent, final KeyStroke accelerator,
	    final IconEnum iconEnum, final String actionCommand, final String windowName, final boolean writeAccess) {
	return addMenuItem(menu, menuItemAction, keyEvent, accelerator, iconEnum, actionCommand, windowName, writeAccess, false);
    }
     ...
     */
    private JMenuItem addMenuItem(final JMenu menu, final Action menuItemAction, final int keyEvent, final KeyStroke accelerator,
	    final IconEnum iconEnum, final String actionCommand, final String windowName, final boolean writeAccess, final boolean adminOnly) {
	...
	public void actionPerformed(final ActionEvent arg0) {
	    ...
	    TransportOverviewReportHandler transportOverviewReportHandler = new TransportOverviewReportHandler(steinChecker);
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(ExcelReportEnum.PRODUCTIVITY_PACK, new Dimension(320, 150));
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(ExcelReportEnum.TAKSTOL_OWN_ORDER_REPORT, new Dimension(320,
		    110));
	    openFrame(new ExcelReportView(excelReportViewHandler, false));
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(ExcelReportEnum.DRAWER_REPORT, new Dimension(320, 130));
	    openFrame(new ExcelReportView(excelReportViewHandler, false));
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(ExcelReportEnum.POST_SHIPMENT_SENT_COUNT, new Dimension(320,
		    130));
	    openFrame(new ExcelReportView(excelReportViewHandler, false));
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandlerDeviation excelReportViewHandler = new ExcelReportViewHandlerDeviation("Avvik", true, ExcelReportEnum.DEVIATION_SUM);
	    openFrame(new ExcelReportView(excelReportViewHandler, false));
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandlerDeviation excelReportViewHandler = new ExcelReportViewHandlerDeviation("Avvik pr aviksfunksjon", true,
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandlerDeviation excelReportViewHandler = new ExcelReportViewHandlerDeviation("Avvik - Skjema gjennomgåelse", false,
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(ExcelReportEnum.TRANSPORT_LIST, new Dimension(320, 130));
	    openFrame(new ExcelReportView(excelReportViewHandler, false));
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandlerOwnProduction excelReportViewHandler = new ExcelReportViewHandlerOwnProduction(ExcelReportEnum.OWN_PRODUCTION);
	    openFrame(new ExcelReportView(excelReportViewHandler, false));
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(ExcelReportEnum.PRODUCTIVITY_LIST_NOT_INVOICED, new Dimension(
		    250, 110));
	    openFrame(new ExcelReportView(excelReportViewHandler, false));
	}
    }
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(ExcelReportEnum.PACKLIST_NOT_READY, new Dimension(250, 110));
	    openFrame(new ExcelReportView(excelReportViewHandler, false));
	}
    }
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(ExcelReportEnum.PRODUCTIVITY_ORDER_STATUS, new Dimension(250,
		    110));
	    openFrame(new ExcelReportView(excelReportViewHandler, false));
	}
    }
	 ...
	 */
	public void actionPerformed(final ActionEvent arg0) {
	    ExcelReportViewHandler excelReportViewHandler = new ExcelReportViewHandler(ExcelReportEnum.READY_COUNT, new Dimension(250, 110));
	    openFrame(new ExcelReportView(excelReportViewHandler, false));
	}
    }
	...
	public void actionPerformed(final ActionEvent arg0) {
	    ...
	    Util.showMsgFrame(ProTransMain.PRO_TRANS_MAIN.getContentPane(), "ProTrans - Grimstad Industrier", "Versjon " + MainClass.version);
