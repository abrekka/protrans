...
/**
 * Klasse som håndterer opprettelse av vindu for artikkeltype
 * 
 * @author atle.brekka
 */
public class ArticleTypeAction extends AbstractAction {
	...
	@Inject
	public ArticleTypeAction(MenuBarBuilderInterface aMenuBarBuilder,
			ArticleTypeViewHandlerFactory aArticleTypeViewHandlerFactory) {
		super("Artikkeltyper...");
	...
	public void actionPerformed(final ActionEvent arg0) {
		/*
		 * menuBarBuilder .openFrame(new OverviewView<ArticleType,
		 * ArticleTypeModel>( new ArticleTypeViewHandler(null, menuBarBuilder
		 * .getUserType(), articleTypeManager, attributeManager,
		 * attributeChoiceManager)));
		 */
		menuBarBuilder
				.openFrame(new OverviewView<ArticleType, ArticleTypeModel>(
						articleTypeViewHandler));
