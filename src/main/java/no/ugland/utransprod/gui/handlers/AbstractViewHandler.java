...
public abstract class AbstractViewHandler<T, E> extends Model implements Updateable, Closeable {
	 ...
	 */
	public AbstractViewHandler(final String aHeading, final OverviewManager<T> aOverviewManager,
	 ...
	 */
	protected abstract AbstractEditView<E, T> getEditView(AbstractViewHandler<T, E> handler, T object,
			boolean searching);
	...
	protected final boolean openEditView(final T object, final boolean searching, final WindowInterface parentWindow,
		...
		if (viewHandlerExt != null) {
			hasOpenViewExt = viewHandlerExt.openEditViewExt(object, searching, parentWindow,lettvekt);
		}
	...
	protected boolean handleDeleteCheckObject(WindowInterface window, boolean returnValue, int selectedIndex, T object,
	...
	private boolean handleCanContinueDelete(WindowInterface window, boolean returnValue, int selectedIndex, T object,
			String msg) {
