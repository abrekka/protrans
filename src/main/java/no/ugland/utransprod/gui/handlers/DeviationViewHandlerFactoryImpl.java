...
public class DeviationViewHandlerFactoryImpl implements DeviationViewHandlerFactory {
	...
	@Inject
	public DeviationViewHandlerFactoryImpl(Login aLogin, ManagerRepository aManagerRepository,
	...
	public DeviationViewHandler2 create(Order aOrder, boolean doSeAll, boolean forOrderInfo, boolean isForRegisterNew,
		...
		return new DeviationViewHandler2(login, managerRepository, preventiveActionViewHandler,
