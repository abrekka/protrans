 ...
 * @author atle.brekka
 */
public class PreventiveActionViewHandler extends
		AbstractViewHandler<PreventiveAction, PreventiveActionModel> {
	 ...
	 */
	@Inject
	public PreventiveActionViewHandler(Login aLogin,
			ManagerRepository managerRepository) {
		super("Korrigerende tiltak", managerRepository
	...
	public JTextField getTextFieldManager(PresentationModel presentationModel) {
		JTextField textField = BasicComponentFactory
				.createTextField(presentationModel
						.getBufferedModel(PreventiveActionModel.PROPERTY_MANAGER));
	...
	public JTextArea getTextAreaDescription(PresentationModel presentationModel) {
		JTextArea textArea = BasicComponentFactory
				.createTextArea(presentationModel
						.getBufferedModel(PreventiveActionModel.PROPERTY_DESCRIPTION));
	 ...
	 * @return tekstområde
	 */
	public JTextArea getTextAreaExpectedOutcome(
			PresentationModel presentationModel) {
		JTextArea textArea = BasicComponentFactory
				.createTextArea(presentationModel
						.getBufferedModel(PreventiveActionModel.PROPERTY_EXPECTED_OUTCOME));
	 ...
	 * @return sjekkboks
	 */
	public JCheckBox getCheckBoxClosed(PresentationModel presentationModel,
			WindowInterface window) {
		checkBoxClosed = BasicComponentFactory
				.createCheckBox(
						presentationModel
								.getBufferedModel(PreventiveActionModel.PROPERTY_PROJECT_CLOSED_BOOLEAN),
						"Lukket");
		checkBoxClosed.setName("CheckBoxClosed");
		checkBoxClosed.addActionListener(new CheckBoxActionListener(window,
				presentationModel));
	 ...
	 */
	@Override
	public CheckObject checkSaveObject(PreventiveActionModel object,
	...
	private final class PreventiveActionTableModel extends AbstractTableAdapter {
		...
		public PreventiveActionTableModel(ListModel listModel) {
			super(listModel,
					new String[] { "Prosjektnr", "Prosjektnavn",
							"Prosjektleder", "Funksjon", "Kategori", "Lukket",
							"Status" });
		}
	 ...
	 * @param presentationModel
	 */
	void addComment(PreventiveActionComment comment,
			PresentationModel presentationModel) {
		comment.setPreventiveAction(((PreventiveActionModel) presentationModel
				.getBean()).getObject());
		commentList.add(0, comment);
		presentationModel.setBufferedValue(
				PreventiveActionModel.PROPERTY_COMMENTS, commentList);
	}
	...
	class CheckBoxActionListener implements ActionListener {
		 ...
		 * @param aPresentationModel
		 */
		public CheckBoxActionListener(WindowInterface aWindow,
				PresentationModel aPresentationModel) {
			window = aWindow;
			presentationModel = aPresentationModel;
		}
