 ...
 * @author atle.brekka
 */
public final class TransportOrderTableModelList extends AbstractTableAdapter {
	 ...
	 */
	TransportOrderTableModelList(ListModel aListModel, ArrayListModel aOrderList,
	...
	public TransportOrderTableModelList clone(TransportColumn.ForExcel forExcel) {
		return new TransportOrderTableModelList(listModel, list, gavlChecker, takstolChecker, steinChecker,
				gulvsponChecker, forExcel);
	}
	...
	public enum TransportColumn {
		...
		FIRMA("Firma", ForExcel.BOTH) {
			...
			public Object getValue(Transportable transportable, Map<String, String> statusMap,
				...
				return transport == null || transport.getSupplier() == null ? null
						: transport.getSupplier().getSupplierName();
			}
			...
			@Override
			public void setPrefferedWidth(JXTable table) {
				table.getColumnExt(table.getColumnExt(getColumnName()).getModelIndex()).setPreferredWidth(120);

			}
		},
		SJÅFØR("Sjåfør", ForExcel.TABLE) {
			@Override
			public Object getValue(Transportable transportable, Map<String, String> statusMap,
					StatusCheckerInterface<Transportable> gavlChecker,
					StatusCheckerInterface<Transportable> takstolChecker,
					...
					StatusCheckerInterface<Transportable> gulvsponChecker) {
				Transport transport = transportable.getTransport();
				return transport == null ? null : transport.getDriver();
			}
			...
			public Object getValue(Transportable transportable, Map<String, String> statusMap,
				...
				if (!Hibernate.isInitialized(transportable.getOrderLines())) {
					...
					orderManager.lazyLoadOrder(transportable.getOrder(),
						...
						PostShipmentManager postShipmentManager = (PostShipmentManager) ModelUtil.getBean("orderManager");
		...
		SENDT("Sendt", ForExcel.TABLE) {
			...
			public Object getValue(Transportable transportable, Map<String, String> statusMap,
					...
					StatusCheckerInterface<Transportable> steinChecker,
					StatusCheckerInterface<Transportable> gulvsponChecker) {
				return transportable.getSent() == null ? null : Util.SHORT_DATE_FORMAT.format(transportable.getSent());
			}
			...
			@Override
			public void setPrefferedWidth(JXTable table) {
				table.getColumnExt(table.getColumnExt(getColumnName()).getModelIndex()).setPreferredWidth(70);
		...
		REST("Rest", ForExcel.TABLE) {
			...
			public Object getValue(Transportable transportable, Map<String, String> statusMap,
					...
					StatusCheckerInterface<Transportable> steinChecker,
					StatusCheckerInterface<Transportable> gulvsponChecker) {
				return transportable.getPaidDate() != null ? "Nei" : "Ja";
			}
