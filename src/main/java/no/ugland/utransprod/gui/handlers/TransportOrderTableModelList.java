...
public final class TransportOrderTableModelList extends AbstractTableAdapter {
     ...
     */
    TransportOrderTableModelList(ListModel aListModel, ArrayListModel aOrderList, StatusCheckerInterface<Transportable> aGavlChecker,
	...
	return new TransportOrderTableModelList(listModel, list, gavlChecker, takstolChecker, steinChecker, gulvsponChecker, forExcel);
    }
	...
	FIRMA("Firma", ForExcel.BOTH) {
		...
		return transport == null || transport.getSupplier() == null ? null : transport.getSupplier().getSupplierName();
	    }
