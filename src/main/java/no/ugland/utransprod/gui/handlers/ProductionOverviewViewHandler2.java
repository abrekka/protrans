 ...
 * @author atle.brekka
 */
public class ProductionOverviewViewHandler2 implements ProductAreaGroupProvider, OrderNrProvider, ProduceableProvider, Updateable, Closeable,
	ProductionoverviewFilterListener {
	...
	PAKKLISTE("Pakkliste", false, 80, true) {
		...
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.PACKLIST_READY), false);
	    }
		...
		return productionOverviewV1.getPacklistReady() == null && productionOverviewV2.getPacklistReady() == null ? 0 : productionOverviewV1
			.getPacklistReady() == null ? -1 : productionOverviewV2.getPacklistReady() == null ? 1 : productionOverviewV1
			.getPacklistReady().compareTo(productionOverviewV2.getPacklistReady());
	    }
	},
	LAGET_PAKKLISTE("Laget pakkliste", false, 90, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.PACKLIST_DONE_BY), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getPacklistDoneBy())) {
		    return productionOverviewV.getPacklistDoneBy() != null
			    && productionOverviewV.getPacklistDoneBy().toLowerCase()
				    .matches(productionoverviewFilter.getPacklistDoneBy().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getPacklistDoneBy() == null && productionOverviewV2.getPacklistDoneBy() == null ? 0
			: productionOverviewV1.getPacklistDoneBy() == null ? -1 : productionOverviewV2.getPacklistDoneBy() == null ? 1
				: productionOverviewV1.getPacklistDoneBy().compareTo(productionOverviewV2.getPacklistDoneBy());
	    }
	},
	TIDSBRUK_PAKKLISTE("Tidsbruk pakkliste", true, 100, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.PACKLIST_DURATION), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getPacklistDuration())) {
		    return productionOverviewV.getPacklistDuration() != null
			    && String.valueOf(productionOverviewV.getPacklistDuration()).toLowerCase()
				    .matches(productionoverviewFilter.getPacklistDuration().toLowerCase().replaceAll("%", ".*"));
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getPacklistDuration() == null && productionOverviewV2.getPacklistDuration() == null ? 0
			: productionOverviewV1.getPacklistDuration() == null ? -1 : productionOverviewV2.getPacklistDuration() == null ? 1
				: productionOverviewV1.getPacklistDuration().compareTo(productionOverviewV2.getPacklistDuration());
	    }
	},
	ORDRENR("Ordrenr", false, 90, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.ORDERNR), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getOrderNr())) {
		    return productionOverviewV.getOrderNr() != null
			    && productionOverviewV.getOrderNr().toLowerCase()
	...
	FORNAVN("Fornavn", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.FIRSTNAME), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getFirstname())) {
		    return productionOverviewV.getFirstName() != null
			    && productionOverviewV.getFirstName().toLowerCase()
				    .matches(productionoverviewFilter.getFirstname().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getFirstName() == null && productionOverviewV2.getFirstName() == null ? 0 : productionOverviewV1
			.getFirstName() == null ? -1 : productionOverviewV2.getFirstName() == null ? 1 : productionOverviewV1.getFirstName()
	...
	ETTERNAVN("Etternavn", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.LASTNAME), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getLastname())) {
		    return productionOverviewV.getLastName() != null
			    && productionOverviewV.getLastName().toLowerCase()
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getLastName() == null && productionOverviewV2.getLastName() == null ? 0 : productionOverviewV1
			.getLastName() == null ? -1 : productionOverviewV2.getLastName() == null ? 1 : productionOverviewV1.getLastName().compareTo(
			productionOverviewV2.getLastName());
	    }
	},
	POSTNR("Postnr", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.POSTAL_CODE), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getPostalCode())) {
		    return productionOverviewV.getPostalCode() != null
			    && productionOverviewV.getPostalCode().toLowerCase()
				    .matches(productionoverviewFilter.getPostalCode().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getPostalCode() == null && productionOverviewV2.getPostalCode() == null ? 0 : productionOverviewV1
			.getPostalCode() == null ? -1 : productionOverviewV2.getPostalCode() == null ? 1 : productionOverviewV1.getPostalCode()
	...
	STED("Sted", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.POSTOFFICE), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getPostoffice())) {
		    return productionOverviewV.getPostOffice() != null
			    && productionOverviewV.getPostOffice().toLowerCase()
				    .matches(productionoverviewFilter.getPostoffice().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getPostOffice() == null && productionOverviewV2.getPostOffice() == null ? 0 : productionOverviewV1
			.getPostOffice() == null ? -1 : productionOverviewV2.getPostOffice() == null ? 1 : productionOverviewV1.getPostOffice()
	...
	TYPE("Type", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.CONSTRUCTION_TYPE_NAME), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getConstructionTypeName())) {
		    return productionOverviewV.getConstructionTypeName() != null
			    && productionOverviewV.getConstructionTypeName().toLowerCase()
				    .matches(productionoverviewFilter.getConstructionTypeName().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getConstructionTypeName() == null && productionOverviewV2.getConstructionTypeName() == null ? 0
			: productionOverviewV1.getConstructionTypeName() == null ? -1 : productionOverviewV2.getConstructionTypeName() == null ? 1
				: productionOverviewV1.getConstructionTypeName().compareTo(productionOverviewV2.getConstructionTypeName());
	    }
	},
	STØRRELSE("Størrelse", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.INFO), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getInfo())) {
		    return productionOverviewV.getInfo() != null
			    && productionOverviewV.getInfo().toLowerCase()
		...
		return productionOverviewV1.getInfo() == null && productionOverviewV2.getInfo() == null ? 0
			: productionOverviewV1.getInfo() == null ? -1 : productionOverviewV2.getInfo() == null ? 1 : productionOverviewV1.getInfo()
				.compareTo(productionOverviewV2.getInfo());
	    }
	},
	AVDELING("Avdeling", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.PRODUCT_AREA), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getProductArea())) {
		    return productionOverviewV.getProductArea() != null
			    && productionOverviewV.getProductArea().toLowerCase()
				    .matches(productionoverviewFilter.getProductArea().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getProductArea() == null && productionOverviewV2.getProductArea() == null ? 0 : productionOverviewV1
			.getProductArea() == null ? -1 : productionOverviewV2.getProductArea() == null ? 1 : productionOverviewV1.getProductArea()
	...
	PROD_UKE("Prod.uke", true, 70, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.PRODUCTION_WEEK), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getProductionWeek())) {
		    return productionOverviewV.getProductionWeek() != null
			    && String.valueOf(productionOverviewV.getProductionWeek()).toLowerCase()
				    .matches(productionoverviewFilter.getProductionWeek().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getProductionWeek() == null && productionOverviewV2.getProductionWeek() == null ? 0
			: productionOverviewV1.getProductionWeek() == null ? -1 : productionOverviewV2.getProductionWeek() == null ? 1
				: productionOverviewV1.getProductionWeek().compareTo(productionOverviewV2.getProductionWeek());
	    }
	},
	TRANSPORT("Transport", false, 120, true) {
		...
		return productionOverviewV.getTransportYear() == null ? "" : productionOverviewV.getTransportYear() + " "
			+ productionOverviewV.getTransportWeek() + "-" + productionOverviewV.getTransportName();
	    }
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.TRANSPORT), false);
	    }
	...
	ESTIMERT_TID_VEGG("Estimert tid vegg", true, 100, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.ESTIMATED_TIME_WALL), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getEstimatedTimeWall())) {
		    return productionOverviewV.getEstimatedTimeWall() != null
			    && String.valueOf(productionOverviewV.getEstimatedTimeWall()).toLowerCase()
				    .matches(productionoverviewFilter.getEstimatedTimeWall().toLowerCase().replaceAll("%", ".*"));
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getEstimatedTimeWall() == null && productionOverviewV2.getEstimatedTimeWall() == null ? 0
			: productionOverviewV1.getEstimatedTimeWall() == null ? -1 : productionOverviewV2.getEstimatedTimeWall() == null ? 1
				: productionOverviewV1.getEstimatedTimeWall().compareTo(productionOverviewV2.getEstimatedTimeWall());
	    }
	},
	TID_VEGG("Tid vegg", true, 80, true) {
		...
		return productionOverviewV.getWallRealProductionHours() == null ? Tidsforbruk.beregnTidsforbruk(
			productionOverviewV.getWallActionStarted(), productionOverviewV.getWallProduced()) : productionOverviewV
			.getWallRealProductionHours();
	    }
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.TIME_WALL), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getTimeWall())) {
		    return calculateTimeWall(productionOverviewV) != null
			    && String.valueOf(calculateTimeWall(productionOverviewV)).toLowerCase()
				    .matches(productionoverviewFilter.getTimeWall().toLowerCase().replaceAll("%", ".*"));
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return calculateTimeWall(productionOverviewV1) == null && calculateTimeWall(productionOverviewV2) == null ? 0
			: calculateTimeWall(productionOverviewV1) == null ? -1 : calculateTimeWall(productionOverviewV2) == null ? 1
				: calculateTimeWall(productionOverviewV1).compareTo(calculateTimeWall(productionOverviewV2));
	    }
	},
	ESTIMERT_TID_GAVL("Estimert tid gavl", true, 90, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.ESTIMATED_TIME_GAVL), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getEstimatedTimeGavl())) {
		    return productionOverviewV.getEstimatedTimeGavl() != null
			    && String.valueOf(productionOverviewV.getEstimatedTimeGavl()).toLowerCase()
				    .matches(productionoverviewFilter.getEstimatedTimeGavl().toLowerCase().replaceAll("%", ".*"));
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getEstimatedTimeGavl() == null && productionOverviewV2.getEstimatedTimeGavl() == null ? 0
			: productionOverviewV1.getEstimatedTimeGavl() == null ? -1 : productionOverviewV2.getEstimatedTimeGavl() == null ? 1
				: productionOverviewV1.getEstimatedTimeGavl().compareTo(productionOverviewV2.getEstimatedTimeGavl());
	    }
	},
	TID_GAVL("Tid gavl", true, 80, true) {
		...
		return productionOverviewV.getGavlRealProductionHours() == null ? Tidsforbruk.beregnTidsforbruk(
			productionOverviewV.getGavlActionStarted(), productionOverviewV.getGavlProduced()) : productionOverviewV
			.getGavlRealProductionHours();
	    }
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.TIME_GAVL), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getTimeWall())) {
		    return calculateTimeGavl(productionOverviewV) != null
			    && String.valueOf(calculateTimeGavl(productionOverviewV)).toLowerCase()
				    .matches(productionoverviewFilter.getTimeGavl().toLowerCase().replaceAll("%", ".*"));
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return calculateTimeGavl(productionOverviewV1) == null && calculateTimeGavl(productionOverviewV2) == null ? 0
			: calculateTimeGavl(productionOverviewV1) == null ? -1 : calculateTimeGavl(productionOverviewV2) == null ? 1
				: calculateTimeGavl(productionOverviewV1).compareTo(calculateTimeGavl(productionOverviewV2));
	    }
	},
	ESTIMERT_TID_PAKK("Estimert tid pakk", true, 90, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.ESTIMATED_TIME_PACK), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getEstimatedTimePack())) {
		    return productionOverviewV.getEstimatedTimePack() != null
			    && String.valueOf(productionOverviewV.getEstimatedTimePack()).toLowerCase()
				    .matches(productionoverviewFilter.getEstimatedTimePack().toLowerCase().replaceAll("%", ".*"));
		}
		return true;
	    }
	...
	VEGG("Vegg", true, 50, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.WALL_STATUS), false);
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return hentVeggstatus(statusMap1, statusCheckers) == null && hentVeggstatus(statusMap2, statusCheckers) == null ? 0 : hentVeggstatus(
			statusMap1, statusCheckers) == null ? -1 : hentVeggstatus(statusMap2, statusCheckers) == null ? 1 : hentVeggstatus(
			statusMap1, statusCheckers).compareTo(hentVeggstatus(statusMap2, statusCheckers));
	    }
	},
	GULVSPON("Gulvspon", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.GULVSPON_STATUS), false);
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return hentGulvsponstatus(statusMap1, statusCheckers) == null && hentGulvsponstatus(statusMap2, statusCheckers) == null ? 0
			: hentGulvsponstatus(statusMap1, statusCheckers) == null ? -1 : hentGulvsponstatus(statusMap2, statusCheckers) == null ? 1
				: hentGulvsponstatus(statusMap1, statusCheckers).compareTo(hentGulvsponstatus(statusMap2, statusCheckers));
	    }
	},
	TAKSTOL("Takstol", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.TAKSTOL_STATUS), false);
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return hentTakstolstatus(statusMap1, statusCheckers) == null && hentTakstolstatus(statusMap2, statusCheckers) == null ? 0
			: hentTakstolstatus(statusMap1, statusCheckers) == null ? -1 : hentTakstolstatus(statusMap2, statusCheckers) == null ? 1
				: hentTakstolstatus(statusMap1, statusCheckers).compareTo(hentTakstolstatus(statusMap2, statusCheckers));
	    }
	},
	GAVL("Gavl", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.GAVL_STATUS), false);
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return hentGavlstatus(statusMap1, statusCheckers) == null && hentGavlstatus(statusMap2, statusCheckers) == null ? 0 : hentGavlstatus(
			statusMap1, statusCheckers) == null ? -1 : hentGavlstatus(statusMap2, statusCheckers) == null ? 1 : hentGavlstatus(
			statusMap1, statusCheckers).compareTo(hentGavlstatus(statusMap2, statusCheckers));
	    }
	},
	...
	PAKK("Pakk", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.PAKK_STATUS), false);
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return hentPakkstatus(statusMap1, statusCheckers) == null && hentPakkstatus(statusMap2, statusCheckers) == null ? 0 : hentPakkstatus(
			statusMap1, statusCheckers) == null ? -1 : hentPakkstatus(statusMap2, statusCheckers) == null ? 1 : hentPakkstatus(
			statusMap1, statusCheckers).compareTo(hentPakkstatus(statusMap2, statusCheckers));
	    }
	},
	...
	TAKSTEIN("Takstein", false, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.TAKSTEIN_STATUS), false);
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return hentTaksteinstatus(statusMap1, statusCheckers) == null && hentTaksteinstatus(statusMap2, statusCheckers) == null ? 0
			: hentTaksteinstatus(statusMap1, statusCheckers) == null ? -1 : hentTaksteinstatus(statusMap2, statusCheckers) == null ? 1
				: hentTaksteinstatus(statusMap1, statusCheckers).compareTo(hentTaksteinstatus(statusMap2, statusCheckers));
	    }
	},
	MONTERING("Montering", true, 80, true) {
		...
		if (transportable.getDoAssembly() != null && transportable.getDoAssembly() == 1) {
		    returnString = "M" + (transportable.getAssemblyWeek() == null ? "" : transportable.getAssemblyWeek());
		}
		return returnString;
	    }
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.MONTERING), false);
	    }
		...
		return hentMontering(productionOverviewV1) == null && hentMontering(productionOverviewV2) == null ? 0
			: hentMontering(productionOverviewV1) == null ? -1 : hentMontering(productionOverviewV2) == null ? 1 : hentMontering(
				productionOverviewV1).compareTo(hentMontering(productionOverviewV2));
	    }
	},
	EGENPRODUKSJON("Egenproduksjon", true, 90, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.EGENPRODUKSJON), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getEgenproduksjon())) {
		    return productionOverviewV.getOwnProduction() != null
			    && String.valueOf(productionOverviewV.getOwnProduction()).toLowerCase()
				    .matches(productionoverviewFilter.getEgenproduksjon().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getOwnProduction() == null && productionOverviewV2.getOwnProduction() == null ? 0 : productionOverviewV1
			.getOwnProduction() == null ? -1 : productionOverviewV2.getOwnProduction() == null ? 1 : productionOverviewV1
			.getOwnProduction().compareTo(productionOverviewV2.getOwnProduction());
	    }
	},
	// PROCENT("%") {
	// @Override
	...
	KOST("Kost", true, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.KOST), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getKost())) {
		    return productionOverviewV.getOwnProductionInternal() != null
			    && String.valueOf(productionOverviewV.getOwnProductionInternal()).toLowerCase()
				    .matches(productionoverviewFilter.getKost().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getOwnProductionInternal() == null && productionOverviewV2.getOwnProductionInternal() == null ? 0
			: productionOverviewV1.getOwnProductionInternal() == null ? -1 : productionOverviewV2.getOwnProductionInternal() == null ? 1
				: productionOverviewV1.getOwnProductionInternal().compareTo(productionOverviewV2.getOwnProductionInternal());
	    }
	},
	FRAKT("Frakt", true, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.FRAKT), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getFrakt())) {
		    return productionOverviewV.getDeliveryCost() != null
			    && String.valueOf(productionOverviewV.getDeliveryCost()).toLowerCase()
				    .matches(productionoverviewFilter.getFrakt().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getDeliveryCost() == null && productionOverviewV2.getDeliveryCost() == null ? 0 : productionOverviewV1
			.getDeliveryCost() == null ? -1 : productionOverviewV2.getDeliveryCost() == null ? 1 : productionOverviewV1.getDeliveryCost()
	...
	MONTERINGSUM("Monteringsum", true, 80, true) {
	    ...
	    @Override
	    public Component getFilterComponent(PresentationModel presentationModel) {
		return BasicComponentFactory.createTextField(presentationModel.getModel(ProductionoverviewFilter.MONTERINGSUM), false);
	    }
		...
		if (StringUtils.isNotBlank(productionoverviewFilter.getMonteringsum())) {
		    return productionOverviewV.getAssemblyCost() != null
			    && String.valueOf(productionOverviewV.getAssemblyCost()).toLowerCase()
				    .matches(productionoverviewFilter.getMonteringsum().toLowerCase().replaceAll("%", ".*") + ".*");
		}
		return true;
	    }
	    ...
	    public int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		    Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers) {
		return productionOverviewV1.getAssemblyCost() == null && productionOverviewV2.getAssemblyCost() == null ? 0 : productionOverviewV1
			.getAssemblyCost() == null ? -1 : productionOverviewV2.getAssemblyCost() == null ? 1 : productionOverviewV1.getAssemblyCost()
	...
	public abstract boolean filter(ProductionOverviewV productionOverviewV, ProductionoverviewFilter productionoverviewFilter,
		Map<String, String> statusMap, Map<String, StatusCheckerInterface<Transportable>> statusCheckers);

	public abstract int sort(ProductionOverviewV productionOverviewV1, ProductionOverviewV productionOverviewV2, Map<String, String> statusMap1,
		Map<String, String> statusMap2, Map<String, StatusCheckerInterface<Transportable>> statusCheckers);
    }
	...
	table.getColumnModel().getColumn(ProductionColumn.ORDRENR.ordinal()).setCellRenderer(new TextPaneRendererProductionoverviewV());
	...
	protected List<Icon> getIcons(ProductionOverviewV transportable) {
	    ...
	    boolean added = StringUtils.isNotBlank(transportable.getComment()) ? icons.add(IconEnum.ICON_COMMENT.getIcon()) : false;
	    added = StringUtils.isNotBlank(transportable.getSpecialConcern()) ? icons.add(IconEnum.ICON_WARNING.getIcon()) : false;
