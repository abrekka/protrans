...
public class InvoiceViewHandler extends AbstractProductionPackageViewHandlerShort<FaktureringV> {
	...
	super(login, managerRepository, deviationViewHandlerFactory, aInvoiceApplyList, "Fakturering", TableEnum.TABLEINVOICE);
    }
	...
	FaktureringV currentFaktureringV = managerRepository.getFaktureringVManager().findByOrderNr(faktureringV.getOrderNr());
	...
	public InvoiceTableModel(ListModel listModel) {
	    super(listModel, new String[] { "Ordre", "Sent", "Beløp", "Fakturert", "Montert", "Produktområde" });
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		if (faktureringV.getSent() != null) {
		    return Util.SHORT_DATE_FORMAT.format(faktureringV.getSent());
		}
		return null;
	    case 2:
