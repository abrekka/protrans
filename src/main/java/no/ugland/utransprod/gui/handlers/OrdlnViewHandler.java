...
//      Pris
    ...
    private static final class OrdlnTableModel extends AbstractTableAdapter {
        ...
        private static final String[] COLUMNS = {"Linjenr", "Produktnr",
                "Beskrivelse", "Antall", "Rabatt", "Monteringspris",
                "Kostpris", "Pris"};
        ...
        public Object getValueAt(final int rowIndex, final int columnIndex) {
            ...
            case 3:
                if (ordln.getNoOrg() != null) {
                    return ordln.getNoOrg().setScale(2);
                }
                return null;
            case 4:
                if (ordln.getDiscount() != null) {
                    return ordln.getDiscount().setScale(2);
                }
                return null;
            case 5:
                if (ordln.getFree1() != null) {
                    return ordln.getFree1().setScale(2);
                }
                return null;
            case 6:
                if (ordln.getCostPrice() != null) {
                    return ordln.getCostPrice().setScale(2);
                }
                return null;
            case 7:
                if (ordln.getPrice() != null) {
                    return ordln.getPrice().setScale(2);
                }
                return null;
            default:
