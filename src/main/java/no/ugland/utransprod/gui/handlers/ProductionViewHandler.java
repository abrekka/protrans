...
public class ProductionViewHandler extends AbstractProductionPackageViewHandler<Produceable> {
	...
	public ProductionViewHandler(final ApplyListInterface<Produceable> productionInterface, final String title,
			...
			final ArticleType aArticleType, ManagerRepository managerRepository,
...
//		}
	...
	protected ProductionUnit setProductionUnit(WindowInterface window, Produceable produceable) {
		SetProductionUnitAction setProductionUnitAction = setProductionUnitActionFactory.create(articleType, null,
				window);
