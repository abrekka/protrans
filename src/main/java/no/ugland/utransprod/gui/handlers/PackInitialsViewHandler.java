...
public class PackInitialsViewHandler implements Closeable {
	...
	JComboBox comboBox = new JComboBox(new ComboBoxAdapter(packInitials, presentationModel.getModel(Initials.PROPERTY_INITIALS_1)));
	...
	return new JComboBox(new ComboBoxAdapter(packInitials, presentationModel.getModel(Initials.PROPERTY_INITIALS_2)));
    }
	...
	return new JComboBox(new ComboBoxAdapter(packInitials, presentationModel.getModel(Initials.PROPERTY_INITIALS_3)));
    }
	...
	List<String> initialList = (List<String>) presentationModel.getValue(Initials.PROPERTY_INITIAL_LIST);
	...
	public List<String> getInitialList() {
	    ...
	    Collections.addAll(returnList, new String[] { initials1, initials2, initials3 });
	    return returnList;
	}
	...
	if (presentationModel.getValue(Initials.PROPERTY_INITIALS_1) == null) {
	    Util.showErrorDialog(window, "Må sette pakker", "Må sette mins en pakker!");
	    return false;
	}
	return true;
    }
