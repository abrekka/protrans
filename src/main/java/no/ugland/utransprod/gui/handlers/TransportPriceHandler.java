...
public class TransportPriceHandler implements Threadable {
    ...
    public TransportPriceHandler(final Component comp,
            final TransportCostActionEnum aTransportCostActionEnum,final ManagerRepository aManagerRepository) {
    ...
    public final void doWhenFinished(final Object object) {
        if (object != null) {
            ...
            Util
            .showMsgDialog(component, "Importert",
                    "Ferdig med import");
        }
        if (waitWindow != null) {
            waitWindow.dispose();
    ...
    public enum TransportCostActionEnum {
        IMPORT {
			@Override
			public void doImport(WindowInterface window,TransportCostManager transportCostManager,JLabel label,String excelFileName)  throws ProTransException{
        ...
        UPDATE {
			@Override
			public void doImport(WindowInterface window,
					TransportCostManager transportCostManager, JLabel label,
					String excelFileName)  throws ProTransException{
				transportCostManager.updatePricesFromFile(excelFileName);
        ...
        public abstract void doImport(WindowInterface window,TransportCostManager transportCostManager,JLabel label,String excelFileName) throws ProTransException;
    }
}
