...
public final class AssemblyTeamTableModel extends AbstractTableAdapter {
	 ...
	 * 
	 */
	// private static final String[] COLUMNS = { "Sent", "Montert",
	// "Ordre","Planlagt", "Opprinnelig", "Overtid", "Sendt mangler","Montert"
	// };
	 ...
	 * @param aWindow
	 */
	AssemblyTeamTableModel(ListModel listModel, ArrayListModel aAssemblyList, WindowInterface aWindow) {
