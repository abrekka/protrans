...
import no.ugland.utransprod.gui.handlers.LevertTransportViewHandler;
 ...
 * @author atle.brekka
 */
public class LevertTransportView implements EditViewable {
    private LevertTransportViewHandler viewHandler;
     ...
     * @param handler
     */
    public LevertTransportView(final LevertTransportViewHandler handler) {
        viewHandler = handler;
    }
    ...
    private void initComponents(WindowInterface window) {
        window.setName("LevertTransportView");
