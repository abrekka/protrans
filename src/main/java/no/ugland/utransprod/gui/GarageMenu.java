...
import no.ugland.utransprod.gui.action.PaidAction;
...
public class GarageMenu extends ProTransMenu {
	...
	@Inject
	public GarageMenu(final Login aLogin, final CustomerAction aCustomerAction,
			final OrderAction aOrderAction,
			final TransportAction aTransportAction,
			final AssemblyAction aAssemblyAction,
			final InvoiceAction aInvoiceAction,
			final IncomingOrderAction aIncomingOrderAction,
			final PacklistAction aPacklistAction,
			final ExternalOrderAction aExternalOrderAction,final PaidAction aPaidAction,final TaksteinAction aTaksteinAction,final TransportCostAction aTransportCostAction) {
		super(aLogin);
	...
	public JMenu buildMenu() {
		...
		addMenuItem(menuGarage, customerAction, KeyEvent.VK_K, null, null,
				null, "Kunde", false);
		addMenuItem(menuGarage, orderAction, KeyEvent.VK_O, null, null, null,
				"Ordre", false);
		addMenuItem(menuGarage, transportAction, KeyEvent.VK_T, null, null,
				null, "Transport", false);
		addMenuItem(menuGarage, assemblyAction, KeyEvent.VK_M, null, null,
				null, "Montering", false);
		addMenuItem(menuGarage, invoiceAction, KeyEvent.VK_F, null, null, null,
				"Fakturering", false);
		addMenuItem(menuGarage, incomingOrderAction, KeyEvent.VK_A, null, null,
				null, "Ordre til avrop", false);
		addMenuItem(menuGarage, packlistAction, KeyEvent.VK_P, null, null,
				null, "Pakkliste", false);
		addMenuItem(menuGarage, externalOrderAction, KeyEvent.VK_B, null, null,
				null, "Bestillinger", false);
		addMenuItem(menuGarage, paidAction, KeyEvent.VK_R, null, null, null,
				"Forhåndsbetaling", false);
		addMenuItem(menuGarage, taksteinAction,
				KeyEvent.VK_S, null, null, null, "Takstein", false);
		addMenuItem(menuGarage, transportCostAction,
				KeyEvent.VK_N, null, null, null, "Transportkostnad", false);
		return menuGarage;
	}
