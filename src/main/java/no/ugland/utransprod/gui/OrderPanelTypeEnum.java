...
public enum OrderPanelTypeEnum {
	NEW_ORDERS(new String[] { "ØUke", "Type", "Mont.", "Pnr.", "Poststed",
			"Stein", "Kunde", "Ordrenr", "Adresse", "Produktområde","Sannsynlighet","Takstoltegner" },9) {
				@Override
	...
	ASSEMBLY_ORDERS(
			new String[] { "Type", "Pnr.", "Poststed", "Kunde", "Ordrenr",
					"Adresse", "Transport", "Produktområde" },7) {
						@Override
						public Object getKundeInfo(Transportable transportable) {
							return transportable.getOrder();
						}
					}, 
	ORDER(new String[] { "Kunde",
			"Ordrenr", "Adresse", "Postnummer", "Poststed", "Type",
			"Transport", "Produktområde" },7) {
				@Override
				public Object getKundeInfo(Transportable transportable) {
					return transportable.getCustomer();
				}
			}, 
	DEVIATION(new String[] { "Kunde",
			"Ordrenr", "Adresse", "Postnummer", "Poststed", "Type",
			"Transport", "Produktområde" },7) {
				@Override
				public Object getKundeInfo(Transportable transportable) {
	...
	CONFIRM_REPORT(new String[] {
			"Kunde", "Ordrenr", "Adresse", "Postnummer", "Poststed", "Type",
			"Transport", "Egenproduksjon", "Frakt", "Montering", "Intern",
			"Dekningsgrad" },0) {
				@Override
				public Object getKundeInfo(Transportable transportable) {
					return transportable.getCustomer();
			...
			INCOMING_ORDER(new String[] { "Kunde",
					"Ordrenr", "Adresse", "Postnummer", "Poststed", "Type",
					"Transport", "Produktområde","Status" },7) {
						@Override
						public Object getKundeInfo(Transportable transportable) {
							return transportable.getCustomer();
						}
	...
	public Object getValueAt(Transportable transportable,int columnIndex, StatusCheckerInterface<Transportable> steinChecker, Map<String, String> statusMap){
	...
	public enum OrderColumn{
		ØUKE {
			@Override
			public Object getValue(Transportable transportable, Map<String, String> statusMap,StatusCheckerInterface<Transportable> steinChecker,OrderPanelTypeEnum orderPanelTypeEnum) {
		...
		public abstract Object getValue(Transportable transportable, Map<String, String> statusMap,StatusCheckerInterface<Transportable> steinChecker,OrderPanelTypeEnum orderPanelTypeEnum);
