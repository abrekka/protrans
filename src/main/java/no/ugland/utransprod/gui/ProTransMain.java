...
public class ProTransMain extends JFrame implements MainWindow {
	 ...
	 */
	@Inject
	public ProTransMain(MenuBarBuilderInterface aMenuBarBuilderInterface,
			Login aLogin) {
	...
	public Component buildFrame() {
		...
		setJMenuBar(menuBarBuilder.buildMenuBar(this, login
				.getApplicationUser(), login.getUserType()));
