...
public class EditAssemblyView extends AbstractEditView<AssemblyModel, Assembly> {
     ...
     * @param aViewHandler
     */
    public EditAssemblyView(final boolean searchDialog, final AssemblyModel assemblyModel, final SupplierOrderViewHandler aViewHandler) {
	...
	FormLayout layout = new FormLayout("10dlu,p,3dlu,p,3dlu,p,3dlu,55dlu,10dlu", "10dlu,p,3dlu,p,3dlu,p,3dlu,50dlu,3dlu,p,5dlu");
	...
	builder.add(ButtonBarFactory.buildCenteredBar(buttonSave, buttonCancel), cc.xyw(2, 10, 7));
