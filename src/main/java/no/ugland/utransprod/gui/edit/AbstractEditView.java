...
public abstract class AbstractEditView<E, T> implements Closeable, Updateable, CancelListener, EditViewable {
	 ...
	 * @param aViewHandler
	 */
	public AbstractEditView(final boolean searchDialog, final AbstractModel<T, E> object,
	 ...
	 */
	public AbstractEditView(final boolean searchDialog, final AbstractModel<T, E> object,
			final AbstractViewHandler<T, E> aViewHandler, final PresentationModel aPresentationModel) {
	...
	private void initComponents(final WindowInterface window) {
		...
		if (search) {
			...
			buttonCancel = new CancelButton(window, this, false, Util.getGuiProperty("button.cancel.text"),
	...
	private void initEventHandling() {
		// if (!search) {
		PropertyConnector connector = new PropertyConnector(presentationModel, PresentationModel.PROPERTYNAME_BUFFERING,
				buttonSave, "enabled");
