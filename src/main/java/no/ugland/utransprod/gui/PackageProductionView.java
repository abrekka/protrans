...
public class PackageProductionView {
	...
	labelAggregateDeviationProc = viewHandler.getLabelAggregateDeviationProc();
	...
	FormLayout layout = new FormLayout("fill:p:grow", "p,100dlu,bottom:p:grow");
	...
	panel.add(builder.getPanel(), new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0,
		0, 0), 0, 0));
	return panel;
	...
	initComponents();
	FormLayout layout = new FormLayout("p,15dlu,p,15dlu,p,50dlu,p,15dlu,p,15dlu", "p,p,p");
	...
	PackageProductionView packageProductionView = new PackageProductionView(packageProductionViewHandler);
